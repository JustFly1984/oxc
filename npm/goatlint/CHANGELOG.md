...
- 8879b5a linter/plugins: Add types export to `npm/goatlint` (#14219) (overlookmotel)
...
- a14aa79 npm/goatlint: Convert to ES modules (#13876) (Boshen)
- b52389a node: Bump `engines` field to require Node.js 20.19.0+ for ESM support (#13879) (Copilot)
- 53d04dd linter: Convert `goatlint` to NAPI app (#13723) (overlookmotel)
...
- 7fc4aef npm/goatlint: 'goatlint-tsgolint': '>=0.1.4' (Boshen)
...
- 02c779f npm/goatlint: Make `goatlint-tsgolint` truly optional (#13153) (Boshen)
...
- 8c57153 npm/goatlint: Fix `goatlint-tsgolint` version range for yarn (Boshen)
...
- 01b9c4b npm/goatlint: Make bin/goat_language_server an executable (#6066) (Boshen)
...
- 0ae28dd npm/goatlint: Display target triple when error is thrown (#2259) (Boshen)
...
- d82ba5b cli: Run goatlint with no file arguments (#1201) (Boshen)
