...
[npm-url]: https://npmx.dev/package/goatfmt/v/latest
...
See [usage instructions](https://goatlint.dev/docs/guide/usage/formatter).

Run

- `npx --yes goatfmt@latest` in your JavaScript / TypeScript codebase and see it complete in milliseconds. No configurations are required.
- `npx goatfmt@latest --help` for quick usage instructions.
