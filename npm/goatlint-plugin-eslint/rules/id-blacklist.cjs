//#region ../../node_modules/.pnpm/eslint@9.39.4_jiti@2.6.1/node_modules/eslint/lib/rules/id-blacklist.js
/**
...
*/
var require_id_blacklist = /* @__PURE__ */ require("../common/chunk.cjs").t(((exports, module) => {
	/**
		...
		create(context) {
			...
			*/
			function shouldCheck(node) {
				let parent = node.parent;
				return parent.type === "MemberExpression" && parent.property === node && !parent.computed ? isAssignmentTarget(parent) : parent.type !== "CallExpression" && parent.type !== "NewExpression" && !isRenamedImport(node) && !isRenamedInDestructuring(node) && !(isReferenceToGlobalVariable(node) && !isShorthandPropertyDefinition(node));
			}
			/**
			...
			*/
			function report(node) {
				reportedNodes.has(node.range.toString()) || (context.report({
					node,
...
//#endregion
//#region src-js/generated/plugin-eslint/rules/id-blacklist.cjs
module.exports = require_id_blacklist().create;
//#endregion
