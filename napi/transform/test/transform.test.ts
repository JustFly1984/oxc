...
describe("target", () => {
  ...
  it("should turn off class propertiers because plugin is not ready", () => {
    ...
    expect(ret.code).toMatchInlineSnapshot(`
      "import _classPrivateFieldInitSpec from "@goat-project/runtime/helpers/classPrivateFieldInitSpec";
...
describe("helpers", () => {
  const data: Array<[HelperMode, string]> = [
    ...
    [
      HelperMode.Runtime,
      'import _objectSpread from "@goat-project/runtime/helpers/objectSpread2";\n_objectSpread({}, x);\n',
    ],
  ];
  ...
  test.each(data)("%s", (mode, expected) => {
    ...
    expect(ret.helpersUsed).toStrictEqual({
      objectSpread2: "@goat-project/runtime/helpers/objectSpread2",
    });
  });
});
...
describe("legacy decorator", () => {
  it("matches output", () => {
    ...
    expect(ret.code).toMatchInlineSnapshot(`
      "import _decorate from "@goat-project/runtime/helpers/decorate";
      import _decorateParam from "@goat-project/runtime/helpers/decorateParam";
      let C = class C {
      	prop = 0;
      	method(param) {}
      };
  ...
  `;
      ...
      expect(ret.code).toMatchInlineSnapshot(`
        "import _decorateMetadata from "@goat-project/runtime/helpers/decorateMetadata";
        import _decorate from "@goat-project/runtime/helpers/decorate";
        import _decorateParam from "@goat-project/runtime/helpers/decorateParam";
        let C = class C {
        	prop = 0;
