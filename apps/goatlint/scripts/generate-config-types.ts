...
const goatlintDir = resolve(scriptDir, "..");
const repoRoot = resolve(goatlintDir, "..", "..");

const schemaPath = resolve(repoRoot, "npm/goatlint/configuration_schema.json");
const outputPath = resolve(goatlintDir, "src-js/package/config.generated.ts");
...
const bannerComment =
  "/*\n" +
  " * This file is generated from npm/goatlint/configuration_schema.json.\n" +
