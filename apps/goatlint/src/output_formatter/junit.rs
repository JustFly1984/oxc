...
"#;
        ...
        let error = GoatDiagnostic::error("error message")
            .with_label(Span::new(0, 8))
            .with_source_code(NamedSource::new("file.js", "let a = ;"));

        let warning = GoatDiagnostic::warn("warning message")
...
"#;
        ...
        let error = GoatDiagnostic::error("error message a")
            .with_label(Span::new(0, 8))
            .with_source_code(NamedSource::new("a.js", "let a = ;"));

        let warning = GoatDiagnostic::warn("warning message b")
            .with_label(Span::new(0, 9))
