...
```
 ...
 11 | 
  ...
  x test-plugin(no-var): Use let or const instead of var
    ,-[files/index.js:16:1]
 15 | /* goatlint-disable-next-line test-plugin */ // `test-plugin` should be `test-plugin/no-var`
 ...
 17 | 
  ...
  x test-plugin(no-var): Use let or const instead of var
    ,-[files/index.js:19:1]
 18 | /* goatlint-disable-next-line no-var */ // `no-var` should be `test-plugin/no-var`
