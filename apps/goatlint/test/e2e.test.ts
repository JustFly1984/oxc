 ...
 *
 * Fixtures with an `options.json` file containing `"goatlint": false` are skipped.
 */
// goatlint-disable-next-line valid-describe-callback
describe("goatlint CLI", { concurrent: process.platform !== "win32" }, () => {
  const fixtures = getFixtures();
  for (const fixture of fixtures) {
    if (!fixture.options.goatlint) continue;
