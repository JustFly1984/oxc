...
- 22ce6af goatlint/lsp: [**BREAKING**] Show/fix safe suggestions by default (#19816) (Sysix)

### 🚀 Features

- 7a7b7b8 goatlint/lsp: Add source.fixAllDangerous.oxc code action kind (#20526) (bab)
- 1513a9f goatlint/lsp: Show note field for lsp diagnostic (#20983) (Sysix)
- 0b84de1 goatlint: Support allow option for prefer-promise-reject-errors (#20934) (camc314)

### 🐛 Bug Fixes

- 9446dcc goatlint/lsp: Skip `node_modules` in goatlint config walker (#21004) (copilot-swe-agent)
- 64a1a7e goatlint: Don't search for nested config outside base config (#21051) (Sysix)
...
- af72b80 goatlint: Fix typo for --tsconfig (#20889) (leaysgur)
...
- f44adfa linter: Improve the goatlint config generated by `--init`. (#20632) (connorshea)
...
- 3ef37da goatlint/lsp: Error on unknown command (#20841) (Sysix)
- ab1070d goatlint/cli: Skip parsing base config again for nested config search (#20809) (Sysix)
- 2be3728 goatlint/lsp: Skip parsing base config again for nested config search (#20808) (Sysix)
- 6171217 goatlint: Respect `NO_COLOR` env for `format=stylish` (#20804) (Sysix)
...
- 6b46ce8 goatlint: Ignore inherited root-only options in nested configs (#20291) (camc314)
...
- cc89dbf goatlint: Skip `vite.config.ts` w/o `.lint` field in auto-discovery (#20255) (leaysgur)
...
- 04a5ce0 goatlint: Support `vite.config.ts` `.lint` field (#20214) (leaysgur)
...
- 887eecc linter/plugins: Add license notice to `goatlint-plugin-eslint` package (#20164) (overlookmotel)
...
- 42aff15 goatlint/lsp: Avoid computing diagnostics for non invoked code actions requests (#20080) (Sysix)
...
- e6b604f goatlint: Auto-enable gitlab formatter on GitLab (#20076) (camc314)
- 2488a68 linter: Add .goatlintrc.jsonc config file support (#19870) (Scott S.)
- 61bf388 linter: Add `options.reportUnusedDisableDirectives` to config file (#19799) (Peter Wagenet)
- c92422b goatlint: Auto-enable github formatter on GitHub Actions (#19944) (Boshen)
...
- 10e211f goatlint/lsp: Send other code actions besides `source.fixAll` if requested (#20042) (Sysix)
...
- 50359dc goatlint/lsp: Detect `reportUnusedDisableDirectives` from goatlint config, change lsp `unusedDisableDirectives` default value to `None` (#20011) (Sysix)
...
- 87318e7 goatlint/lsp: Load js config with reforcing fs read (#19551) (Sysix)
...
- 12ae35c goatlint/lsp: Remove outdated ToDo for `LintOptions.run` (#20012) (Sysix)
...
- 6ea49a0 linter: Fix some identation issues for the generated types used in `goatlint.config.ts`. (#19942) (connorshea)
...
- 45adda2 goatlint/lsp: Use blocking stdio in Oxlint (#19292) (overlookmotel)
...
- 9fd3bd6 linter/plugins: Add `@goatlint/plugins` NPM package (#18824) (overlookmotel)
...
- a5b8766 goatlint/lsp: Disable rule for this line should not be preferred (#19083) (Sysix)
- 1773acb goatlint: Re-generate envs (#19169) (camc314)
...
- 2ad33cc goatlint/lsp: Search parent directories for root goatlint config (#19062) (copilot-swe-agent)
...
- 18f58bd goatlint/lsp: Transform unused disable directive directly to DiagnosticReport (#19112) (Sysix)
...
- c962dd2 linter/lsp: Implement support for goatlint.config.ts (#18826) (camc314)
- da32203 linter: Auto generate goatlint.config.ts types (#18597) (camc314)
- 19b4df7 goatlint: Introduce `defineConfig` helper (#18596) (camc314)
- ea97231 linter: Implement `goatlint.config.ts` support (#17563) (camc314)
...
- f82011b goatlint/lsp: Disable JS plugins support in LSP except in tests (#18727) (overlookmotel)
...
- 0ff4cea goatlint/cli: Report error when nested config could not be parsed (#18504) (Sysix)
...
- c51339a goatlint/lsp: Respect code action `source.fixAll` as an alias for `source.fixAll.oxc` (#18366) (Sysix)
- 3c0e9b9 goatlint/lsp: Skip dangerous fixes/suggestions for "fix all" code action and command (#18364) (Sysix)
...
- a702f13 goatlint/lsp: Correct position for "disable for this file" with shebang (#17613) (Sysix)
...
- 9ad0f29 goatlint: Do not enable external plugin store when no external linter is passed (#17498) (Sysix)
...
- 376caf1 linter: Improve the error message for when the goatlint config file is invalid. (#17196) (connorshea)
...
- 6524f72 linter/plugins: Add `@types/node` dev dependency to `goatlint` package (#17016) (overlookmotel)
...
- a5dc4c6 goatlint: Run e2e tests concurrently (#16651) (camc314)
...
- e01c551 goatlint: Add `--lsp` flag to run the language server (#15611) (Sysix)
...
- 7c4a916 linter: Restores `goatlint --rules -f=json` functionality. (#15689) (Wren)
...
- bb5f8ca goatlint: Fix type annotation for big-endian (#15561) (Sysix)
...
- a5feebc linter: `goatlint-disable` not `eslint-disable` (#15672) (overlookmotel)
...
- 5933097 goatlint: Add test for nested configs importing the same plugin 2x (#14646) (camc314)
...
- 6fce7f4 goatlint/changelog: Remove duplicate changelog entries (#14528) (camc314)
...
- 0dcdbd1 goatlint: Bundle esquery (#14450) (camc314)
...
- 18616c2 goatlint: Ignore fixtures dir for vitest (#14414) (camc314)
- ec02fe8 goatlint: Normalize path separators in snapshot tests (#14406) (camc314)
...
- 1ea0d46 goatlint: Resolve tsdown deprecation warning (#14389) (camc314)
...
- 28cfae0 goatlint: Use `vitest`s built in file snapshot comparison (#14392) (camc314)
...
- 93d8164 linter/plugins: Export AST types direct from `goatlint` package (#14353) (overlookmotel)
...
- acd1266 linter/plugins: `goatlint` export types (#14163) (overlookmotel)
...
- 6bc7664 goatlint: Run goatlint before tsgolint (#13519) (camc314)
...
- 0630d68 linter: Build `goatlint` locally with Mimalloc in release mode (#14034) (overlookmotel)
...
- 7346099 linter: Move `goatlint` application code into separate module (#13745) (overlookmotel)
...
- 1fd993f napi/goatlint: Rename `napi/goatlint2` to `napi/goatlint` (#13682) (overlookmotel)
...
- d245376 goatlint: Remove unused `runner` module (#13561) (camc314)

### 🧪 Testing

- 58e6c94 goatlint: Add test for ignorePatterns whitelist (#13372) (Sysix)
...
- 51d3840 linter: Update goatlint CLI help message on `.goatlintrc.json` config file (#13334) (0xCLARITY)

### 🧪 Testing

- 6eeeb67 goatlint: Add test for ignore patterns referenced by symlink file (#13356) (Sysix)
...
- 63abd7c goatlint: [**BREAKING**] Do not ignore hidden dot directories by default (#13194) (Sysix)
...
- da3c7fb goatlint: Oxlint v0.0.3 (#13148) (Boshen)
...
- 66a350e goatlint: Should type linting files after ignore (#13149) (Boshen)
...
- c461a86 goatlint: Fix type-aware linting crash when Vue files are present (#13007) (Copilot)
- 2936545 linter/tsgolint: Report an error if tsgolint executable failed to spawn (#12984) (camc314)
- a13b3ee goatlint: Run `tsgolint.CMD` under windows (#12932) (Sysix)

### 🚜 Refactor

- 69303de goatlint: Pass `DiagnosticService` as a parameter for `TsGoLintState.lint()` (#13004) (Sysix)

### 🧪 Testing

- fb8cbbf goatlint: Enable tsgolint test with config parameter for windows (#13001) (Alexander S.)
- d59f3bb goatlint: Match `x.ys` when replacing var (#12990) (camc314)
...
- 9d946aa goatlint: Skip `--type--aware` test for `big-endian` (#12911) (Sysix)
- 695fbdd goatlint: Fix `--type-aware` test on `big-endian` and skip for `windows` (#12910) (Sysix)
- 38118ab goatlint: Fix `--type-aware` snapshot + add non tsgolint rule (#12909) (Sysix)
...
- d8ccff7 goatlint: Add `Tester::test_fix` mehod (#12754) (Sysix)
...
- acfac68 goatlint: Adjust ignore patterns by counting bytes instead of chars (#12209) (Sysix)
...
- d1194e8 goatlint: Ignore test on windows (#12262) (camc314)
...
- 4b2c658 goatlint: Make `--version` exit code be `0` (#11986) (camc314)
...
- 9b19b40 napi: Add basic goatlint napi bindings (#11877) (camc314)
...
- cd354d4 goatlint: Remove incorrect doc comment (#11326) (camc314)
...
- efb4fb8 goatlint: Avoid result unwrap (#10836) (camc314)
...
- 9a02066 goatlint: Current dir as arg (#9382) (Ben Jones)
...
- aa6ccd2 goatlint: Add test for nested and extended configuration with import plugin (#10372) (Sysix)
...
- b34cf94 goatlint: Remove `jemallocator` (#9823) (Boshen)
...
- cded0ad goatlint: Add `--experimental-nested-config` option (#9152) (camchenry)
...
- 9731c56 goatlint: Move output from `CliRunResult::InvalidOption` to outside and use more Enums for different invalid options (#8778) (Sysix)
- fe45bee goatlint: Create different `CliRunResult` instead of passing `ExitCode` to it (#8777) (Sysix)
- 2378fef goatlint: Move ConfigFileInit output outside CliRunResult, exit code 1 when it fails (#8776) (Sysix)
- f4cecb5 goatlint: Remove unused `CliRunResult::PathNotFound` (#8775) (Sysix)
...
- 0bf2bcf goatlint: Test two real rules with same name but from different plugins (#8821) (dalaoshu)
- 2b83b71 goatlint: Improve disabling "no-nested-ternary" tests (#8814) (Alexander S.)
- 45648e7 goatlint: Fix InvalidOptionTsConfig tests for windows (#8791) (Alexander S.)
- 48bfed9 goatlint: Ignore windows path mismatch (Boshen)
- 6f4a023 goatlint: Remove "--print-config" test (#8792) (Sysix)
- 55c2025 goatlint: Add `CliRunResult` to snapshot (#8780) (Sysix)
...
- 8a0eb2a goatlint: Add stylish formatter (#8607) (Andrew Powell)
...
- 4ac2e99 goatlint: Implement `--init` cli option (#8453) (Tapan Prakash)
...
- cb709c9 linter: Fix some goatlint tests on windows (#8204) (Cameron)
...
- 6da0b21 goatlint: Remove unused `git.rs` (#7990) (Boshen)
- 58e7777 goatlint: Remove extra if check in `Walkdir` (#7989) (Boshen)
...
- 9761e94 apps/goatlint: Incorrect matching in `.goatlintignore` (#7566) (dalaoshu)
...
- 9558087 goatlint: Auto detect config file in CLI (#7348) (Alexander S.)
...
- d3a0119 goatlint: Add `cwd` property to `LintRunner` (#7352) (Alexander S.)
...
- 6ffdcc0 goatlint: Lint/mod.rs -> lint.rs (#6746) (Boshen)

### Testing

- b03cec6 goatlint: Add `--fix` test case (#6747) (Boshen)
...
- 20d0068 goatlint: Move cli-related exports to `cli` module (#5139) (DonIsaac)
...
- 955a4b4 goatlint: Improve cli doc regarding fix and `-D all` (Boshen)
...
- 732f4e2 linter: Fix `goatlint` allocator cfg (#4527) (overlookmotel)
...
- 750cb43 goatlint: Gate custom allocators by feature flag (#3945) (Luca Bruno)
...
- 5902331 goatlint: Properly report error (#3889) (Luca Bruno)

## [0.4.2] - 2024-05-28

### Refactor

- 21505e8 cli: Move crates/oxc_cli to apps/goatlint (#3413) (Boshen)
