...
// goatlint-disable-next-line typescript/ban-ts-comment
...
// Base config for `goatlint-plugin-eslint` package
...
// Build entries for `goatlint-plugin-eslint` rule files.
...
export default defineConfig([
  ...
  // `goatlint-plugin-eslint` package
  {
