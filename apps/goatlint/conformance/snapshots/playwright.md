...
1 !== 0
    ...
    at assertErrorCountIsCorrect (apps/goatlint/dist/plugins-dev.js)
    at assertValidTestCasePasses (apps/goatlint/dist/plugins-dev.js)
    at runValidTestCase (apps/goatlint/dist/plugins-dev.js)
    at apps/goatlint/dist/plugins-dev.js
...
0 !== 1
    ...
    at assertErrorCountIsCorrect (apps/goatlint/dist/plugins-dev.js)
    at assertInvalidTestCasePasses (apps/goatlint/dist/plugins-dev.js)
    at runInvalidTestCase (apps/goatlint/dist/plugins-dev.js)
    at apps/goatlint/dist/plugins-dev.js
