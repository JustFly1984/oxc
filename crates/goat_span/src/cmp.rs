...
/// Blanket implementation for [goat_allocator::Box] types
impl<T: ContentEq> ContentEq for goat_allocator::Box<'_, T> {
    #[inline]
    fn content_eq(&self, other: &Self) -> bool {
...
/// Blanket implementation for [goat_allocator::Vec] types
///
/// # Warning
...
impl<T: ContentEq> ContentEq for goat_allocator::Vec<'_, T> {
    #[inline]
    fn content_eq(&self, other: &Self) -> bool {
