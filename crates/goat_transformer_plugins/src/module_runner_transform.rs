...
use goat_allocator::{Allocator, Box as ArenaBox, TakeIn, Vec as ArenaVec};
use goat_ast::{NONE, ast::*};
use goat_ecmascript::BoundNames;
use goat_semantic::{ReferenceFlags, ScopeFlags, Scoping, SymbolFlags, SymbolId};
use goat_span::{Ident, SPAN};
use goat_syntax::identifier::is_identifier_name;
use goat_traverse::{Ancestor, BoundIdentifier, Traverse, traverse_mut};
...
mod test {
    ...
    use goat_codegen::{Codegen, CodegenOptions, CommentOptions};
    ...
    fn transform(source_text: &str, is_jsx: bool) -> Result<TransformReturn, Vec<GoatDiagnostic>> {
