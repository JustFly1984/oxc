...
- bc0670c tasks,goat_allocator: Add new method clone_in_with_semantic_ids for `CloneIn` trait (#9894) (IWANABETHATGUY)
...
- 6839433 ast: Communicate type of `RegExpFlags` to `goat_ast_tools` with alias type (#8868) (overlookmotel)
...
- a5bdf32 ast_tools: Re-vamp `goat_ast_tools` (#8844) (overlookmotel)
...
- 7f69561 ast: [**BREAKING**] `goat_ast` do not export `BigUint` (#8428) (overlookmotel)
...
- b47aca0 syntax: Use `generate_derive` for `CloneIn` in types outside of `goat_ast` crate. (#5280) (rzvxa)
...
- 8e8fcd0 ast_tools: Rename `goat_ast_codegen` to `goat_ast_tools`. (#4846) (rzvxa)
...
- daa0b2e ast: `goat_ast` crate re-export AST types from other crates (#4773) (overlookmotel)
...
- be87ca8 transform: `goat_traverse` crate (#3169) (overlookmotel)
...
- 6c00908 goat_ast: Add missing ast visits for types (#2938) (Brad Zacher)
