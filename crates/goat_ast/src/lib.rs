...
//! ## Parsing
//!
//! You can obtain an AST by parsing source code with a [`Parser`] from [`goat_parser`].
//!
//! ## Cargo Features
...
//! [`goat_parser`]: <https://docs.rs/goat_parser>
//! [`Parser`]: <https://docs.rs/goat_parser/latest/goat_parser/struct.Parser.html>
