...
use goat_span::{GetSpan, Ident, Str};
...
impl<'a> AstKind<'a> {
    ...
    /// ```
    #[inline]
    pub fn has_argument_with_span(&self, span: goat_span::Span) -> bool {
        match self {
    ...
    /// ```
    #[inline]
    pub fn is_callee_with_span(&self, span: goat_span::Span) -> bool {
        match self {
...
mod tests {
    ...
    fn test_has_argument_with_span_returns_false_for_non_call_expressions() {
        ...
        let num_lit = NumericLiteral {
            ...
            value: 42.0,
            raw: None,
            base: goat_syntax::number::NumberBase::Decimal,
        };
