...
use goat_allocator::{Box, CloneIn, Dummy, GetAddress, TakeIn, UnstableAddress, Vec};
use goat_ast_macros::ast;
use goat_estree::ESTree;
use goat_span::{ContentEq, GetSpan, GetSpanMut, Ident, SourceType, Span, Str};
use goat_syntax::{
    node::NodeId,
    operator::{
...
pub struct BindingIdentifier<'a> {
    ...
    ///
    /// [`semantic analysis`]: <https://docs.rs/goat_semantic/latest/goat_semantic/struct.SemanticBuilder.html>
