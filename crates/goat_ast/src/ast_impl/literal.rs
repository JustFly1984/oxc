...
impl<'a> RegExpLiteral<'a> {
    ...
    pub fn parse_pattern(
    ...
    ) -> goat_diagnostics::Result<goat_regular_expression::ast::Pattern<'a>> {
        ...
        goat_regular_expression::LiteralParser::new(
            allocator,
            pattern_text,
            Some(flags_text),
            goat_regular_expression::Options { pattern_span_offset, flags_span_offset },
        )
        .parse()
    }
}
