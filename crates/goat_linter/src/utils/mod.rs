...
use goat_span::Span;
use goat_syntax::identifier::{is_identifier_part, is_identifier_start};
...
// the crates/goat_linter/data/vitest_compatible_jest_rules.json
// file is also updated. The JSON file is used by the goatlint-migrate
// and eslint-plugin-goatlint repos to keep everything synced.
