...
pub trait Rule: Sized + Default + fmt::Debug {
    ...
    /// to another linter. This allows goatlint to handle the parsing and error handling.
...
pub trait RuleMeta {
    ...
    /// Whether this rule declares a configuration struct in `declare_goat_lint!`.
    ///
...
mod test {
    ...
    fn test_rule_runner_impls() {
        ...
        // The RuleRunner code is automatically generated by the `goat_linter_codegen` crate.
