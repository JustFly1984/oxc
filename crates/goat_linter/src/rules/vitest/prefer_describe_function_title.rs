...
fn prefer_describe_function_title_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Title description can not have the same content as a imported function name.")
