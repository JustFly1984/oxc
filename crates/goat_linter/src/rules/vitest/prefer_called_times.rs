...
fn prefer_called_times_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Use `toBeCalledTimes(1)` or `toHaveBeenCalledTimes(1)` instead of `toBeCalledOnce()` or `toHaveBeenCalledOnce()`")
