...
use goat_ast::{AstKind, ast::ImportDeclarationSpecifier};
...
fn consistent_vitest_vi_diagnostic(span: Span, fn_value: &VitestFnName) -> GoatDiagnostic {
    GoatDiagnostic::warn("The vitest function accessor used is not allowed")
        .with_help(format!(
