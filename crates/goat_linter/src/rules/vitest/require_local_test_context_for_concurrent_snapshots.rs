use goat_ast::{AstKind, ast::MemberExpression};
...
fn require_local_test_context_for_concurrent_snapshots_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Require local Test Context for concurrent snapshot tests")
