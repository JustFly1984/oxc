use goat_ast::ast::{Statement, TSModuleReference};
...
fn first_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Import statements must come first")
        .with_help("Move import statement to the top of the file")
        .with_label(span)
}

fn absolute_first_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Relative imports before absolute imports are prohibited")
