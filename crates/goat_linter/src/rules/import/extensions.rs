...
fn extension_missing_diagnostic(span: Span, is_import: bool) -> GoatDiagnostic {
    let import_or_export = if is_import { "import" } else { "export" };

    GoatDiagnostic::warn(format!("Missing file extension in {import_or_export} declaration."))
