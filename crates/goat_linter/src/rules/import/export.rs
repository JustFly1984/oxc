...
fn no_named_export(module_name: &str, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("No named exports found in module '{module_name}'"))
    ...
    fn run_once(&self, ctx: &LintContext<'_>) {
        ...
        for (name, span) in named_export {
            ...
            if !spans.is_empty() {
                ...
                ctx.diagnostic(
                    GoatDiagnostic::warn(format!("Multiple exports of name '{name}'."))
