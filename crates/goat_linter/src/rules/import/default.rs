...
use goat_span::{Span, VALID_EXTENSIONS};

use crate::{context::LintContext, module_record::ImportImportName, rule::Rule};

fn default_diagnostic(imported_name: &str, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("No default export found in imported module {imported_name:?}"))
