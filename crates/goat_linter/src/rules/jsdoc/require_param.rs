...
use goat_ast::{AstKind, ast::MethodDefinitionKind};
use goat_diagnostics::GoatDiagnostic;
use goat_macros::declare_goat_lint;
use goat_semantic::{AstNode, JSDoc};
...
fn require_param_diagnostic(violations: Vec<Span>) -> GoatDiagnostic {
    GoatDiagnostic::warn("Missing JSDoc `@param` declaration for function parameters.")
