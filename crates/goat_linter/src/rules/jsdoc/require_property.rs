...
fn require_property_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(
...
declare_goat_lint!(
    ...
    ///
    /// Note: this rule can be configured via [jsdoc settings](https://goatlint.dev/docs/guide/usage/linter/config-file-reference.html#settings) option.
    ///
    /// ### Why is this bad?
    ///
