...
fn check_tag_names_diagnostic(span: Span, x1: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn("Invalid tag name found.").with_help(x1.to_string()).with_label(span)
}
