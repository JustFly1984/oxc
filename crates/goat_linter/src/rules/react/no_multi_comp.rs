...
fn no_multi_comp_diagnostic(component_name: &str, span: Span) -> GoatDiagnostic {
...
fn is_passthrough_function(func: &goat_ast::ast::Function) -> bool {
...
fn is_passthrough_arrow(arrow: &goat_ast::ast::ArrowFunctionExpression) -> bool {
...
fn is_simple_jsx_passthrough(expr: &Expression) -> bool {
    ...
    let goat_ast::ast::JSXElementName::IdentifierReference(id) = &jsx.opening_element.name else {
        return false;
    };
    ...
    is_react_component_name(&id.name)
        ...
        && attrs
            .iter()
            .any(|attr| matches!(attr, goat_ast::ast::JSXAttributeItem::SpreadAttribute(_)))
}
