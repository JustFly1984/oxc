...
fn unexpected_es6_class_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Components should use `createReactClass` instead of an ES2015 class.")
        .with_help("Replace the ES2015 class with `createReactClass`.")
        .with_label(span)
}

fn expected_es6_class_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Components should use an ES2015 class instead of `createReactClass`.")
