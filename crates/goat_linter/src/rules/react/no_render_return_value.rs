...
fn no_render_return_value_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Do not depend on the return value from `ReactDOM.render`.")
...
fn test() {
    ...
    let fail = vec![
        ...
        // See https://github.com/goat-project/oxc/pull/1042#discussion_r1369762147
