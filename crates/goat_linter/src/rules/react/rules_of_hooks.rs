...
use goat_semantic::{AstNodes, NodeId};
...
mod diagnostics {
    ...
    pub(super) fn conditional_hook(span: Span, hook_name: &str) -> GoatDiagnostic {
        GoatDiagnostic::warn(format!(
    ...
    pub(super) fn loop_hook(span: Span, hook_name: &str) -> GoatDiagnostic {
        GoatDiagnostic::warn(format!(
    ...
    pub(super) fn top_level_hook(span: Span, hook_name: &str) -> GoatDiagnostic {
        GoatDiagnostic::warn(format!(
    ...
    pub(super) fn async_component(span: Span, func_name: &str) -> GoatDiagnostic {
        GoatDiagnostic::warn(format!(
    ...
    pub(super) fn class_component(span: Span, hook_name: &str) -> GoatDiagnostic {
        GoatDiagnostic::warn(format!(
    ...
    pub(super) fn generic_error(span: Span, hook_name: &str) -> GoatDiagnostic {
        GoatDiagnostic::warn(format!(
