...
fn require_to_destruct(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("useState call is not destructured into value + setter pair")
        .with_help(
...
fn follow_naming_convention(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("useState call does not follow the [thing, setThing] naming convention")
