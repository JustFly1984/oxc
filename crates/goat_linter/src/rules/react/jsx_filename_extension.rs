...
fn no_jsx_with_filename_extension_diagnostic(
    ...
    GoatDiagnostic::warn(format!("JSX not allowed in files with extension '.{ext}'"))
        .with_help(format!(
...
fn extension_only_for_jsx_diagnostic(ext: &str, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Only files containing JSX may use the extension '.{ext}'"))
