...
fn this_refs_deprecated(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Using this.refs is deprecated.")
        .with_help("Using this.xxx instead of this.refs.xxx")
        .with_label(span)
}

fn string_in_ref_deprecated(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Using string literals in ref attributes is deprecated.")
