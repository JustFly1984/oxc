...
fn self_closing_comp_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unnecessary closing tag")
...
declare_goat_lint!(
    ...
    /// ```jsx
    /// const elem = <Component linter="goatlint"></Component>
    /// const dom_elem = <div id="goatlint"></div>
    /// const welem = <div id="goatlint">
    ///
    /// </div>
    /// ```
    ///
    ...
    /// ```jsx
    /// const elem = <Component linter="goatlint" />
    /// const welem = <Component linter="goatlint" > </Component>
    /// const dom_elem = <div id="goatlint" />
    /// ```
    SelfClosingComp,
    react,
    style,
