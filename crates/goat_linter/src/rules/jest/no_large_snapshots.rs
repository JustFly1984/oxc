...
fn no_snapshot(line_count: usize, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Snapshot is too long.")
        .with_help(format!(
...
fn too_long_snapshot(line_limit: usize, line_count: usize, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Snapshot is too long.")
        .with_help(format!(
...
fn test() {
    ...
    // Note: Currently goatlint didn't check `.snap` file
    //
