...
fn prefer_to_have_been_called_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Prefer `toHaveBeenCalled()` over `toHaveBeenCalledTimes(0)`")
...
// See <https://github.com/goat-project/oxc/issues/6050> for documentation details.
declare_goat_lint!(
    /// ### What it does
    ///
