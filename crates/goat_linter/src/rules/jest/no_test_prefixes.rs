...
fn no_test_prefixes_diagnostic(preferred_node_name: &str, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Use `{preferred_node_name}` instead.")).with_label(span)
}
