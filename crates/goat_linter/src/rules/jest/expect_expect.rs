...
fn expect_expect_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Test has no assertions")
...
impl<'a, 'b> AssertionVisitor<'a, 'b> {
    ...
    fn check_identifier(&mut self, ident: &goat_ast::ast::IdentifierReference<'a>) {
...
impl<'a> Visit<'a> for AssertionVisitor<'a, '_> {
    ...
    fn visit_expression_statement(&mut self, stmt: &goat_ast::ast::ExpressionStatement<'a>) {
    ...
    fn visit_block_statement(&mut self, block: &goat_ast::ast::BlockStatement<'a>) {
    ...
    fn visit_if_statement(&mut self, if_stmt: &goat_ast::ast::IfStatement<'a>) {
