...
fn no_unneeded_async_expect_function_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unnecessary async function wrapper")
...
fn get_awaited_call_span_from_block(body: &goat_ast::ast::FunctionBody) -> Option<Span> {
