...
use goat_semantic::{AstNode, NodeId};
...
fn use_prefer_each(span: Span, fn_name: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn("Enforce using `each` rather than manual loops")
