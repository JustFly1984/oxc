...
use goat_ast::ast::{BinaryExpression, Expression};
...
fn no_string_case_mismatch_diagnostic(span: Span, method: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Comparison with `{method}()` will always be false due to case mismatch."))
