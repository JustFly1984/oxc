...
use goat_ast::{AstKind, ast::IfStatement, ast::Statement};
...
fn curly_diagnostic(span: Span, keyword: &str, expected: bool) -> GoatDiagnostic {
    ...
    GoatDiagnostic::warn(message).with_label(span)
}
