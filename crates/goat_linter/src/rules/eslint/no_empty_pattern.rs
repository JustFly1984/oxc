...
fn no_empty_array_pattern_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Empty array binding pattern")
...
fn no_empty_object_pattern_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Empty object binding pattern")
