...
/// class A { constructor(){} }
/// ```
fn no_empty_constructor(constructor_span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Empty constructors are unnecessary")
...
/// }
/// ```
fn no_redundant_super_call(constructor_span: Span, super_span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Redundant super call in constructor")
        .with_labels([
