...
fn no_label_var_diagnostic(name: &str, id_span: Span, label_span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Found identifier '{name}' with the same name as a label."))
