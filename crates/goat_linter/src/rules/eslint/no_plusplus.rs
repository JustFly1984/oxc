use goat_ast::{AstKind, ast::UpdateOperator};
...
fn no_plusplus_diagnostic(span: Span, operator: UpdateOperator) -> GoatDiagnostic {
    let diagnostic = GoatDiagnostic::warn(format!(
