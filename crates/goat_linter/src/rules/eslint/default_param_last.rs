use goat_ast::{AstKind, ast::FormalParameter, ast::Function};
...
fn default_param_last_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Default parameters should be last")
