...
fn max_nested_callbacks_diagnostic(num: usize, max: usize, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Too many nested callbacks ({num}). Maximum allowed is {max}."))
