...
use goat_syntax::{line_terminator::is_line_terminator, operator::BinaryOperator};
...
fn no_useless_concat_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected string concatenation of literals.")
