...
fn no_nonoctal_decimal_escape_diagnostic(escape_sequence: &str, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Don't use '{escape_sequence}' escape sequence."))
