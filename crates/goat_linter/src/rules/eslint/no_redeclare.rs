...
fn no_redeclare_diagnostic(name: &str, decl_span: Span, re_decl_span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("'{name}' is already defined."))
...
fn no_redeclare_as_builtin_in_diagnostic(name: &str, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("'{name}' is already defined as a built-in global variable."))
