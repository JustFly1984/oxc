...
fn capitalized_comments_diagnostic(
    ...
    GoatDiagnostic::warn(format!("Comments should not begin with {article} {wrong_case} letter"))
...
fn is_directive_comment(content: &str) -> bool {
    ...
    // e.g. `eslint-disable-next-line`, `goatlint-disable-line`, etc.
    if trimmed.starts_with("eslint-") || trimmed.starts_with("goatlint-") {
        return true;
    }
...
*/", None,
        ...
        ("// goatlint-disable-line", None),
        ("// goatlint-disable-next-line", None),
        ("/* eslint semi:off */", None),
        ("/* eslint-enable */", None),
        ("/* goatlint-disable */", None),
        ("/* goatlint-enable */", None),
        ...
        ("// goatlint-disable-line", Some(serde_json::json!(["always"]))),
        ("// goatlint-disable-next-line", Some(serde_json::json!(["always"]))),
        ("/* eslint semi:off */", Some(serde_json::json!(["always"]))),
        ("/* eslint-enable */", Some(serde_json::json!(["always"]))),
        ("/* goatlint-disable */", Some(serde_json::json!(["always"]))),
        ("/* goatlint-enable */", Some(serde_json::json!(["always"]))),
        ...
        ("/* prettier-ignore */", Some(serde_json::json!(["always"]))),
        ("// goatfmt-ignore", Some(serde_json::json!(["always"]))),
        ("/* goatfmt-ignore */", Some(serde_json::json!(["always"]))),
