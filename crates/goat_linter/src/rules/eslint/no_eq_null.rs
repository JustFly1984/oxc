...
fn no_eq_null_diagnostic(span: Span, suggested_operator: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn("Do not use `null` comparisons without type-checking operators.")
