...
fn for_direction_diagnostic(test_span: Span, update_span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("The update clause in this loop moves the variable in the wrong direction")
