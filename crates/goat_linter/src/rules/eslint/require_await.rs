...
use goat_ast_visit::{Visit, walk::walk_for_of_statement};
...
fn require_await_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Async function has no `await` expression.")
