...
fn no_shadow_restricted_names_diagnostic(shadowed_name: &str, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Shadowing of global properties such as `undefined` is not allowed.")
