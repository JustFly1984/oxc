...
fn max_depth_diagnostic(num: usize, max: usize, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Blocks are nested too deeply ({num}). Maximum allowed is {max}."))
