use goat_ast::{AstKind, ast::LabelIdentifier};
...
fn no_extra_label_diagnostic(label: &LabelIdentifier) -> GoatDiagnostic {
    let label_name = &label.name;
    GoatDiagnostic::warn(format!("This label '{label_name}' is unnecessary"))
