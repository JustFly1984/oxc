...
fn no_inner_declarations_diagnostic(decl_type: &str, body: &str, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Variable or `function` declarations are not allowed in nested blocks")
