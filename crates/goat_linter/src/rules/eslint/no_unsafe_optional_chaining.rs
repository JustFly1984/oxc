...
fn no_unsafe_optional_chaining_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unsafe usage of optional chaining")
        .with_help("If this short-circuits with 'undefined' the evaluation will throw TypeError")
        .with_label(span)
}

fn no_unsafe_arithmetic_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unsafe arithmetic operation on optional chaining")
