...
use goat_span::{GetSpan, Span, ident::FUNCTION};

use crate::{AstNode, context::LintContext, rule::Rule};

fn no_new_func(function_call_span: Span, arguments_span: Option<Span>) -> GoatDiagnostic {
    let mut diagnostic = GoatDiagnostic::warn("Using `new Function` or `Function` is not allowed.")
        .with_help(
