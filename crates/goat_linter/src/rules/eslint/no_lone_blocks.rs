...
use goat_ast::ast::{Declaration, VariableDeclarationKind};
...
fn no_lone_blocks_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Block is unnecessary.")
...
fn no_nested_lone_blocks_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Nested block is redundant.")
