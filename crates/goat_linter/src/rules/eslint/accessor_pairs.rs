...
fn setter_without_getter_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Setter is defined without a getter")
        .with_help("Define a getter for this property")
        .with_label(span)
}

fn getter_without_setter_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Getter is defined without a setter")
    ...
    fn get_define_property_callee<'a>(
        ...
        let member = match callee {
            ...
            Expression::ChainExpression(chain) => match &chain.expression {
                goat_ast::ast::ChainElement::StaticMemberExpression(m) => m,
                _ => return None,
            },
            _ => return None,
        };
