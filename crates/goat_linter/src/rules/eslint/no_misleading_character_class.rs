...
fn surrogate_pair_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected surrogate pair in character class.")
...
fn combining_class_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected combining class in character class.")
...
fn emoji_modifiers_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected emoji modifier in character class.")
...
fn regional_indicator_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected regional indicator in character class.")
...
fn zwj_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected joined character sequence in character class.")
