...
use goat_span::{GetSpan, Span, ident::ARGUMENTS};

fn prefer_rest_params_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Use the rest parameters instead of `arguments`.")
