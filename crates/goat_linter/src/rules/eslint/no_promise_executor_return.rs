...
fn no_promise_executor_return_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Return statement should not be used in Promise executor.")
...
impl Visit<'_> for ReturnStatementFinder {
    fn visit_return_statement(&mut self, it: &goat_ast::ast::ReturnStatement<'_>) {
