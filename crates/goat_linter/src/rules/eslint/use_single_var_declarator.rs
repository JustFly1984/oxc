...
fn use_single_var_declarator_diagnostic(span: Span, kind: &str) -> GoatDiagnostic {
...
impl Rule for UseSingleVarDeclarator {
    fn run<'a>(&self, node: &AstNode<'a>, ctx: &LintContext<'a>) {
        ...
        let kind = match decl.kind {
            goat_ast::ast::VariableDeclarationKind::Var => "var",
            goat_ast::ast::VariableDeclarationKind::Let => "let",
            goat_ast::ast::VariableDeclarationKind::Const => "const",
            goat_ast::ast::VariableDeclarationKind::Using => "using",
            goat_ast::ast::VariableDeclarationKind::AwaitUsing => "await using",
        };
