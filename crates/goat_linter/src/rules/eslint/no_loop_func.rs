...
use goat_semantic::{AstNode, SymbolId};
use goat_span::{GetSpan, Span};
use goat_syntax::symbol::SymbolFlags;

use crate::{context::LintContext, rule::Rule};

fn no_loop_func_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Function declared in a loop contains unsafe references to variable(s)")
