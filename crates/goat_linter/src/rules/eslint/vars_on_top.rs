...
use goat_ast::ast::{Declaration, Expression, Program, Statement, VariableDeclarationKind};
...
fn vars_on_top_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("All 'var' declarations must be at the top of the function scope.")
