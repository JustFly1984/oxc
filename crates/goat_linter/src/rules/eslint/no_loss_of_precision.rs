...
use goat_ast::{AstKind, ast::NumericLiteral};
...
fn no_loss_of_precision_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("This number literal will lose precision at runtime.")
        .with_help(
