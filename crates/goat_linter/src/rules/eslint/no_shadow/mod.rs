...
pub fn no_shadow_diagnostic(span: Span, name: &str, shadowed_span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("'{name}' is already declared in the upper scope."))
        .with_help(format!(
...
pub fn no_shadow_global_diagnostic(span: Span, name: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("'{name}' is already a global variable."))
