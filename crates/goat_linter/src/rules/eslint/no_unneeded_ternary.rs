...
fn no_unneeded_ternary_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unnecessary use of boolean literals in conditional expression")
        .with_help("Remove this ternary operator")
        .with_label(span)
}

fn no_unneeded_ternary_conditional_expression_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unnecessary use of conditional expression for default assignment")
