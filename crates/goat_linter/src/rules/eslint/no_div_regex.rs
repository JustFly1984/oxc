...
use goat_regular_expression::ast::{CharacterKind, Term};
use goat_span::Span;

use crate::{AstNode, context::LintContext, rule::Rule};

fn no_div_regex_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("A regular expression literal can be confused with '/='.")
