...
fn max_classes_per_file_diagnostic(total: usize, max: usize, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("File has too many classes ({total}). Maximum allowed is {max}",))
