...
use goat_syntax::operator::BinaryOperator;
...
fn expected_block_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Expected block statement surrounding arrow body.")
        .with_help("Surround the arrow body with braces and use a return statement.")
        .with_label(span)
}

fn unexpected_block_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected block statement surrounding arrow body.")
        .with_help("Move the returned value to be immediately after the `=>`.")
        .with_label(span)
}

fn unexpected_empty_block_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected empty block statement surrounding arrow body.")
...
fn unexpected_block_with_unknown_help_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected block statement surrounding arrow body.").with_label(span)
}
