use goat_ast::{AstKind, ast::BlockStatement};
...
fn no_empty_diagnostic(stmt_kind: &str, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected empty block statements")
