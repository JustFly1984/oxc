...
fn no_useless_escape_diagnostic(escape_char: char, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Unnecessary escape character {escape_char:?}")).with_label(span)
}
...
fn test() {
    ...
    let fix = vec![
        ...
        (r"/[[\.&]&&[\.&]]/v", r"/[[.&]&&[.&]]/v", None), // { "ecmaVersion": 2024 }
        (
            // https://github.com/goat-project/oxc/issues/5227
