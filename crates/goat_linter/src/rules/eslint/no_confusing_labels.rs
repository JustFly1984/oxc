...
fn no_confusing_labels_diagnostic(span: Span, name: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Label '{name}' is confusing because it shares a name with a variable in scope."))
