...
fn prefer_object_destructuring(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Use Object destructuring.")
        .with_help("Use object destructuring rather than direct member access.")
        .with_label(span)
}

fn prefer_array_destructuring(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Use Array destructuring.")
