...
use goat_ast::ast::{Argument, Expression};
...
fn use_regex_literals_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Use a regular expression literal instead of the `RegExp` constructor.")
