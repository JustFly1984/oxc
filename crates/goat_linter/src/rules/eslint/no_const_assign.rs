...
fn no_const_assign_diagnostic(name: &str, decl_span: Span, assign_span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Unexpected re-assignment of `const` variable {name}."))
