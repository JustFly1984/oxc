...
fn no_throw_literal_diagnostic(span: Span, is_undef: bool) -> GoatDiagnostic {
    let message =
...
declare_goat_lint!(
    ...
    ///
    /// ::: warning
    /// This rule has been deprecated, please instead use [typescript/only-throw-error](https://goatlint.dev/docs/guide/usage/linter/rules/typescript/only-throw-error.html).
