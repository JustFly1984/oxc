...
fn no_inline_comments_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected comment inline with code")
...
fn is_directive_comment(comment: &Comment, text: &str) -> bool {
    ...
    // goatlint-disable, goatlint-disable-line, goatlint-disable-next-line
    // eslint-enable, goatlint-enable
