...
fn no_unexpected_multiline_diagnostic(kind: &DiagnosticKind) -> GoatDiagnostic {
    match kind {
        DiagnosticKind::FunctionCall { open_paren_span } => GoatDiagnostic::warn(
        ...
        DiagnosticKind::PropertyAccess { open_bracket_span } => GoatDiagnostic::warn(
