...
use goat_syntax::operator::{BinaryOperator, UnaryOperator};

use crate::{AstNode, context::LintContext, rule::Rule};

fn no_compare_neg_zero_diagnostic(operator: &str, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Do not use the {operator} operator to compare against -0."))
