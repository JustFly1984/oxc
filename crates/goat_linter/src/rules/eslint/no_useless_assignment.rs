...
fn no_useless_assignment_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("This assigned value is not used in subsequent statements.")
...
impl NoUselessAssignment {
    ...
    fn process_reference_deferred(
        ...
        reference: &Reference,
        compact_idx: u32,
        var_decl: &goat_ast::ast::VariableDeclarator,
        decl_node: &goat_semantic::AstNode,
