...
use goat_span::{GetSpan, Span, ident::ARRAY};

use crate::{AstNode, context::LintContext, rule::Rule};

fn no_array_constructor_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Avoid calls to the `Array` constructor")
