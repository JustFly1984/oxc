...
fn no_typos_diagnostic(typo: &str, suggestion: &str, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("`{typo}` may be a typo. Did you mean `{suggestion}`?"))
