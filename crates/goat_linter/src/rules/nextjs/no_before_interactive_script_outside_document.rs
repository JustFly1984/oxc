...
fn no_before_interactive_script_outside_document_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("next/script's `beforeInteractive` strategy should not be used outside of `pages/_document.js`")
