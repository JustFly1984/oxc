...
fn no_img_element_diagnostic(span: Span, src_span: Option<Span>) -> GoatDiagnostic {
    let mut diagnostic = GoatDiagnostic::warn("Using `<img>` could result in slower LCP and higher bandwidth.")
