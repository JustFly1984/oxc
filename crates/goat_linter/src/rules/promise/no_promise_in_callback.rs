use goat_ast::{AstKind, ast::FormalParameters};
...
fn no_promise_in_callback_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Avoid using promises inside of callbacks.")
