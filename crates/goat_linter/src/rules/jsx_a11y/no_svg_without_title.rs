...
use goat_ast::ast::{JSXChild, JSXElementName};
...
fn no_svg_without_title_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("SVG elements must have a `<title>` element or an accessible label.")
        .with_help(
