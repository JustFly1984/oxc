...
fn aria_unsupported_elements_diagnostic(span: Span, attr_name: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn("This element does not support ARIA roles, states, or properties.")
