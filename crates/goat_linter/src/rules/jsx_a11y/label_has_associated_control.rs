...
fn label_has_associated_control_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("A form label must be associated with a control.")
...
fn label_has_associated_control_diagnostic_no_label(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("A form label must have accessible text.")
