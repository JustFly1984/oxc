...
use goat_ast::ast::{JSXAttributeItem, JSXAttributeValue};
...
fn use_unique_element_ids_diagnostic(span: Span, id: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Duplicate element id `{id}`."))
