...
fn click_events_have_key_events_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Enforce a clickable non-interactive element has at least one keyboard event listener.")
