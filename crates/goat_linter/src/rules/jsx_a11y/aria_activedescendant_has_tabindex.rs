...
fn aria_activedescendant_has_tabindex_diagnostic(span: Span, el_name: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn("Elements with `aria-activedescendant` must be tabbable.")
