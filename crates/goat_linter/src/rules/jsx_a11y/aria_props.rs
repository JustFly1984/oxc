...
fn aria_props_diagnostic(span: Span, prop_name: &str, suggestion: Option<&str>) -> GoatDiagnostic {
    let mut err = GoatDiagnostic::warn(format!("'{prop_name}' is not a valid ARIA attribute."));
