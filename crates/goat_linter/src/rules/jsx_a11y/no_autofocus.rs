...
fn no_autofocus_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("The `autoFocus` attribute is found here, which can cause usability issues for sighted and non-sighted users.")
