...
fn ban_tslint_comment_diagnostic(tslint_comment: &str, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("tslint comment detected: \"{tslint_comment}\"")).with_label(span)
}
