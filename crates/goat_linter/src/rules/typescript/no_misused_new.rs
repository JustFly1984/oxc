...
fn no_misused_new_interface_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Interfaces cannot be constructed, only classes.")
        .with_help("Consider removing this method from your interface.")
        .with_label(span)
}

fn no_misused_new_class_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Class cannot have method named `new`.")
