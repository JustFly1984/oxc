...
fn prefer_namespace_keyword_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Use `namespace` instead of `module` to declare custom TypeScript modules.")
