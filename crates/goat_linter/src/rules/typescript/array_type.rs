...
declare_goat_lint!(
    ...
    /// ```typescript
    /// /*goatlint array-type: ["error", { "default": "array" }] */
    /// const arr: Array<number> = new Array<number>();
    /// ```
    ///
    /// ```typescript
    /// /*goatlint array-type: ["error", { "default": "generic" }] */
    /// const arr: number[] = new Array<number>();
    /// ```
    ///
    /// ```typescript
    /// /*goatlint array-type: ["error", { "default": "array-simple" }] */
...
fn generic(readonly_prefix: &str, name: &str, type_name: &str, span: Span) -> GoatDiagnostic {
...
fn array(readonly_prefix: &str, type_name: &str, generic_name: &str, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!(
