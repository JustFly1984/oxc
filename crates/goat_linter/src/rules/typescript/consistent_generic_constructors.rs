...
fn consistent_generic_constructors_diagnostic_prefer_annotation(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(
...
fn consistent_generic_constructors_diagnostic_prefer_constructor(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(
...
impl ConsistentGenericConstructors {
    fn check<'a>(
        &self,
        node: &AstNode<'a>,
        type_annotation: Option<&goat_allocator::Box<'a, TSTypeAnnotation<'a>>>,
