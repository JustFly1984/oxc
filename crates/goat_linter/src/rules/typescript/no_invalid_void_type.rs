...
fn invalid_void_for_generic_diagnostic(span: Span, generic: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Do not use `void` as a type argument for `{generic}`."))
        .with_help(
...
fn invalid_void_not_return_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Use `void` only as a return type.")
        .with_help(
            "Replace this `void` type with an allowed type, or keep `void` only in a valid return position.",
        )
        .with_label(span)
...
fn invalid_void_not_return_or_generic_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Use `void` only as a return type or generic type argument.")
        .with_help(
            "Replace this `void` type with an allowed type, or keep `void` only in a valid return position.",
        )
        .with_label(span)
...
fn invalid_void_not_return_or_this_param_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Use `void` only as a return type or as the type of a `this` parameter.")
        .with_help(
            "Replace this `void` type with an allowed type, or keep `void` only in a valid return position.",
        )
        .with_label(span)
...
fn invalid_void_not_return_or_this_param_or_generic_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(
...
fn invalid_void_union_constituent_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Remove `void` from this union type constituent.")
        .with_help(
            "Replace this `void` type with an allowed type, or keep `void` only in a valid return position.",
        )
        .with_label(span)
...
impl NoInvalidVoidType {
    ...
    fn not_return_for_disabled_generics(&self, span: Span) -> GoatDiagnostic {
        if self.0.allow_as_this_parameter {
    ...
    fn not_return_for_options(&self, span: Span, in_union: bool) -> GoatDiagnostic {
