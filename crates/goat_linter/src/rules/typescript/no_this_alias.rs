...
fn no_this_alias_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected aliasing of 'this' to local variable.")
...
fn no_this_destructure_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected aliasing of members of 'this' to local variables.")
        .with_help(
