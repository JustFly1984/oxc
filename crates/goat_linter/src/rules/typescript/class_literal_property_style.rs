...
fn prefer_field_style_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Literals should be exposed using readonly fields.")
        .with_help("Replace this getter with a readonly field initialized to the returned literal.")
        .with_label(span)
}

fn prefer_getter_style_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Literals should be exposed using getters.")
...
fn has_duplicate_setter<'a>(
    ...
    getter: &goat_ast::ast::MethodDefinition<'a>,
) -> bool {
