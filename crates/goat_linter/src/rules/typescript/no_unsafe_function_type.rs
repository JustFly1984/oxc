...
fn no_unsafe_function_type_diagnostic(span: Span) -> GoatDiagnostic {
    // See <https://goatlint.dev/docs/contribute/linter/adding-rules.html#diagnostics> for details
    GoatDiagnostic::warn("The `Function` type accepts any function-like value.")
