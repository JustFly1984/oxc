use goat_ast::{AstKind, ast::TSModuleDeclarationName};
...
fn no_namespace_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("ES2015 module syntax is preferred over namespaces.")
