...
use goat_syntax::operator::{AssignmentOperator, BinaryOperator, UnaryOperator, UpdateOperator};

use crate::{AstNode, context::LintContext, rule::Rule, utils::is_same_expression};

fn prefer_for_of_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(
