...
fn no_non_null_asserted_nullish_coalescing_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("'Disallow non-null assertions in the left operand of a nullish coalescing operator")
