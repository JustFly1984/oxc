...
fn no_unnecessary_parameter_property_assignment_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Assignment of parameter property is unnecessary")
