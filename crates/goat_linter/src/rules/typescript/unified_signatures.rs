...
fn unified_signatures_diagnostic<L: Into<LabeledSpan>, T: IntoIterator<Item = L>>(
    ...
    GoatDiagnostic::warn(message).with_labels(labels)
}
...
fn get_statement_overload<'a>(
    ...
    match module_declaration {
        goat_ast::ast::ModuleDeclaration::ExportNamedDeclaration(export_named) => {
        ...
        goat_ast::ast::ModuleDeclaration::ExportDefaultDeclaration(export_default) => {
