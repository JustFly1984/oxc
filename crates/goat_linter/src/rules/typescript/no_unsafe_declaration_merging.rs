use goat_ast::{AstKind, ast::BindingIdentifier};
...
fn no_unsafe_declaration_merging_diagnostic(span: Span, span1: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unsafe declaration merging between classes and interfaces.")
