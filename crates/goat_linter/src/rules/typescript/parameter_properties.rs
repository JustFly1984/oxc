...
fn prefer_class_property_diagnostic(parameter: &str, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Property {parameter} should be declared as a class property."))
        .with_help("Remove the parameter modifier and declare this member on the class instead.")
        .with_label(span)
}

fn prefer_parameter_property_diagnostic(parameter: &str, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Property {parameter} should be declared as a parameter property."))
