...
use goat_span::{CompactStr, Span, ident::REQUIRE};
...
fn no_require_imports_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Expected \"import\" statement instead of \"require\" call")
