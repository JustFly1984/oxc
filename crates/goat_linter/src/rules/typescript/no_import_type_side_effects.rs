...
fn no_import_type_side_effects_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("TypeScript will only remove the inline type specifiers which will leave behind a side effect import at runtime.")
