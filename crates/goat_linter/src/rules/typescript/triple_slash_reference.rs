...
fn triple_slash_reference_diagnostic(ref_kind: &str, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Do not use a triple slash reference for {ref_kind}, use `import` style instead."))
