...
use goat_span::{CompactStr, GetSpan, Span, ident::PROCESS};
...
fn no_process_env_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Disallowed usage of `process.env`.")
...
fn is_process_global_object(object_expr: &goat_ast::ast::Expression, ctx: &LintContext) -> bool {
