...
use goat_semantic::{ScopeFlags, Scoping, SymbolId};
use goat_span::Span;
...
fn no_lifecycle_after_await_diagnostic(span: Span, hook_name: &str) -> GoatDiagnostic {
...
impl<'a> Visit<'a> for LifecycleAfterAwaitVisitor<'a> {
    ...
    fn visit_arrow_function_expression(
        &mut self,
        _func: &goat_ast::ast::ArrowFunctionExpression<'a>,
    ) {
    }
}
