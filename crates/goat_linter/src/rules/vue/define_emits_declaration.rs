...
fn has_arg_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Use type based declaration instead of runtime declaration")
        .with_label(span)
}

fn has_type_arg_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Use runtime declaration instead of type based declaration")
        .with_label(span)
}

fn has_type_call_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(
