...
fn has_type_and_arguments_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("`defineProps` has both a type-only emit and an argument.")
...
fn called_multiple_times(span: Span, second_span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("`defineProps` has been called multiple times.")
