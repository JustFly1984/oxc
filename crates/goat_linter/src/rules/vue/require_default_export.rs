...
fn missing_default_export_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Missing default export.").with_label(span)
}

fn must_be_default_export_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Component must be the default export.").with_label(span)
}
