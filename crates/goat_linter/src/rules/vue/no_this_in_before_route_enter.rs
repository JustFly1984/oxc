...
fn no_this_in_before_route_enter_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("`beforeRouteEnter` does NOT have access to `this` component instance.")
