...
fn multiple_arguments_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected multiple arguments.")
        .with_help("Pass only one argument to the slot function.")
        .with_label(span)
}

fn spread_argument_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected spread argument.")
