...
use goat_regular_expression::ast::{
...
fn optimize_regex_diagnostic(span: Span, replacement: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn("This regular expression can be simplified.")
...
fn is_range(
    range: &goat_regular_expression::ast::CharacterClassRange,
    min: char,
    max: char,
) -> bool {
