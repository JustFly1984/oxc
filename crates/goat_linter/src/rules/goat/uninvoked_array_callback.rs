use goat_ast::{AstKind, MemberExpressionKind, ast::Argument};
...
fn uninvoked_array_callback_diagnostic(cb_span: Span, arr_span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Uninvoked array callback")
        .with_help(
