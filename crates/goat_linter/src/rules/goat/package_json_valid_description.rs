...
fn invalid_package_json_description_diagnostic(span: goat_span::Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("The `description` field in package.json must be a non-empty string.")
