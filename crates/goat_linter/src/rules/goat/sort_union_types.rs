...
use goat_ast::{AstKind, ast::TSUnionType};
...
fn sort_union_types_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Union types should be sorted alphabetically.").with_label(span)
}
