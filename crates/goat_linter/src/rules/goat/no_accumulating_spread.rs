...
use goat_semantic::{NodeId, SymbolId};
...
fn reduce_likely_array_spread_diagnostic(spread_span: Span, reduce_span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Do not spread accumulators in Array.prototype.reduce()")
...
fn reduce_likely_object_spread_diagnostic(spread_span: Span, reduce_span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Do not spread accumulators in Array.prototype.reduce()")
...
fn reduce_unknown(spread_span: Span, reduce_span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Do not spread accumulators in Array.prototype.reduce()")
...
fn loop_spread_likely_object_diagnostic(
    ...
    GoatDiagnostic::warn("Do not spread accumulators in loops")
...
fn find_assignment_expression<'a>(
    referenced_symbol_id: SymbolId,
    ctx: &LintContext<'a>,
) -> Option<&'a goat_ast::ast::AssignmentExpression<'a>> {
    let write_reference =
