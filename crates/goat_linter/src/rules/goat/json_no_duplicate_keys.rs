...
use crate::{
    ...
    rule::Rule,
    rules::goat::json_utils::is_json_file,
};

fn json_no_duplicate_keys_diagnostic(span: Span, key: &str, first_span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Duplicate key \"{key}\" in JSON object"))
