...
fn bad_min_max_func_diagnostic(constant_result: f64, span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Math.min and Math.max combination leads to constant result")
        .with_help(format!(
