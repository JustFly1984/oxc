...
use crate::{context::LintContext, rule::Rule, rules::goat::json_utils::is_json_file};

fn json_no_comments_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Comments are not allowed in JSON")
