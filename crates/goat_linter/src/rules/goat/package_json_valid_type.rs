...
fn invalid_package_json_type_diagnostic(actual: &str, span: goat_span::Span) -> GoatDiagnostic {
...
fn non_string_package_json_type_diagnostic(span: goat_span::Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("The `type` field in package.json must be a string.")
