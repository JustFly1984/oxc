...
fn bad_replace_all_arg_diagnostic(replace_all_span: Span, regex_span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Global flag (g) is missing in the regular expression supplied to the `replaceAll` method.")
