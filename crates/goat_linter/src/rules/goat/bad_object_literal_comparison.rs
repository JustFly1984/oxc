...
fn object_comparison(span: Span, const_result: bool) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected object literal comparison.")
        .with_help(format!(
...
fn array_comparison(span: Span, const_result: bool) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected array literal comparison.")
