...
fn no_default_props_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("defaultProps is deprecated")
...
impl Rule for NoDefaultProps {
    fn run<'a>(&self, node: &AstNode<'a>, ctx: &LintContext<'a>) {
        ...
        let goat_ast::ast::AssignmentTarget::StaticMemberExpression(member) = &assign.left else {
            return;
        };
