...
fn detect_non_literal_fs_filename_diagnostic(span: Span, method: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("fs.{method}() called with a non-literal file path"))
