...
fn sort_jsx_props_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("JSX props should be sorted alphabetically.").with_label(span)
}
...
impl Rule for SortJsxProps {
    ...
    fn run<'a>(&self, node: &AstNode<'a>, ctx: &LintContext<'a>) {
        ...
        let named: Vec<(usize, &str)> = element
            ...
            .enumerate()
            .filter_map(|(i, attr)| {
                if let goat_ast::ast::JSXAttributeItem::Attribute(a) = attr {
