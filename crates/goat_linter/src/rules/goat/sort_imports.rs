...
use goat_ast::ast::{ImportDeclaration, Statement};
...
fn sort_imports_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Import statements should be sorted alphabetically by source.")
        .with_label(span)
}
