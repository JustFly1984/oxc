...
use goat_ast::{AstKind, ast::TSIntersectionType};
...
fn sort_intersection_types_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Intersection types should be sorted alphabetically.").with_label(span)
}
