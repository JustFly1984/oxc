...
use goat_syntax::operator::LogicalOperator;

use crate::{AstNode, context::LintContext, rule::Rule};

fn no_leaked_conditional_rendering_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Potential leaked value in JSX conditional rendering")
...
fn is_potentially_leaky(expr: &Expression<'_>) -> bool {
    match expr {
        ...
        Expression::UnaryExpression(unary)
            if unary.operator == goat_syntax::operator::UnaryOperator::LogicalNot =>
        {
            false
        }
        ...
        Expression::BinaryExpression(bin) => {
            ...
            matches!(
                bin.operator,
                goat_syntax::operator::BinaryOperator::Equality
                    | goat_syntax::operator::BinaryOperator::Inequality
                    | goat_syntax::operator::BinaryOperator::StrictEquality
                    | goat_syntax::operator::BinaryOperator::StrictInequality
                    | goat_syntax::operator::BinaryOperator::LessThan
                    | goat_syntax::operator::BinaryOperator::LessEqualThan
                    | goat_syntax::operator::BinaryOperator::GreaterThan
                    | goat_syntax::operator::BinaryOperator::GreaterEqualThan
                    | goat_syntax::operator::BinaryOperator::Instanceof
                    | goat_syntax::operator::BinaryOperator::In
            )
            .not()
        }
