...
fn no_await_in_promise_methods_diagnostic(span: Span, method_name: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Promise in `Promise.{method_name}()` should not be awaited."))
