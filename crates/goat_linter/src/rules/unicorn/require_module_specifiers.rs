...
fn require_module_specifiers_diagnostic(span: Span, statement_type: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Empty {statement_type} specifier is not allowed"))
