...
fn no_unnecessary_slice_end_diagnostic(span: Span, arg_str: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Passing `{arg_str}` as the `end` argument is unnecessary."))
