...
fn prefer_object_from_entries_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Prefer `Object.fromEntries` over manual object construction from entries.")
