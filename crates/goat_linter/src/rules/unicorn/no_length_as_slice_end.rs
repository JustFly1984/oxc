...
fn no_length_as_slice_end_diagnostic(call_span: Span, arg_span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Passing `length` as the end argument of a `slice` call is unnecessary.")
