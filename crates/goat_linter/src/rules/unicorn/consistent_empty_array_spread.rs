...
fn consistent_empty_array_spread_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Prefer consistent types when spreading a ternary in an array literal.")
        .with_label(span)
}
