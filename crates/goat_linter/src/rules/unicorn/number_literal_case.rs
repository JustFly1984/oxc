...
fn uppercase_prefix(span: Span, prefix: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected number literal prefix in uppercase.")
        .with_help(format!("Use lowercase for the number literal prefix `{prefix}`."))
        .with_label(span)
}

fn uppercase_exponential_notation(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected exponential notation in uppercase.")
        .with_help("Use lowercase for `e` in exponential notations.")
        .with_label(span)
}

fn lowercase_hexadecimal_digits(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected hexadecimal digits in lowercase.")
        .with_help("Use uppercase for hexadecimal digits.")
        .with_label(span)
}

fn uppercase_prefix_and_lowercase_hexadecimal_digits(span: Span, prefix: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn(
...
fn check_number_literal(number_literal: &str, raw_span: Span) -> Option<(GoatDiagnostic, String)> {
