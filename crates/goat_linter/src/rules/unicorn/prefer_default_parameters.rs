...
fn prefer_default_parameters_diagnostic(span: Span, name: &str) -> GoatDiagnostic {
    GoatDiagnostic::warn(format!("Prefer default parameters over reassignment for '{name}'."))
...
fn is_side_effect_free_statement(stmt: &goat_ast::ast::Statement, param_name: &str) -> bool {
    use goat_ast::ast::Statement;
...
fn is_side_effect_free_expression(expr: &Expression, param_name: &str) -> bool {
    match expr.without_parentheses() {
        ...
        Expression::UnaryExpression(unary) => {
            !matches!(unary.operator, goat_ast::ast::UnaryOperator::Delete)
