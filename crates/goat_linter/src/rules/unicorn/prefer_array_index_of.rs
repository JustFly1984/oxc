...
fn prefer_array_index_of_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Prefer `indexOf` over `findIndex` for simple equality checks")
...
impl Rule for PreferArrayIndexOf {
    fn run<'a>(&self, node: &AstNode<'a>, ctx: &LintContext<'a>) {
        ...
        let method_span = call_expr
            ...
            .and_then(goat_ast::ast::MemberExpression::static_property_info)
