...
fn non_zero(span: Span, prop_name: &str, op_and_rhs: &str, help: Option<String>) -> GoatDiagnostic {
    let mut d = GoatDiagnostic::warn(format!(
...
fn zero(span: Span, prop_name: &str, op_and_rhs: &str, help: Option<String>) -> GoatDiagnostic {
    let mut d = GoatDiagnostic::warn(format!(
