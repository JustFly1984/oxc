...
fn filename_case_diagnostic(message: String, help_message: String) -> GoatDiagnostic {
    GoatDiagnostic::warn(message).with_label(Span::default()).with_help(help_message)
}
