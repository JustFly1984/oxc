...
fn prefer_global_this_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Prefer `globalThis` over environment-specific global aliases like `window`, `self`, and `global`.")
