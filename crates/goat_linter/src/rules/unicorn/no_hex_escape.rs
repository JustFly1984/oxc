use goat_ast::{AstKind, ast::StringLiteral};
...
fn no_hex_escape_diagnostic(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Use Unicode escapes instead of hexadecimal escapes.").with_label(span)
}
