...
fn unparenthesized_nested_ternary(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected nested ternary expression without parentheses.")
        .with_help("Add parentheses around the nested ternary expression.")
        .with_label(span)
}

fn deeply_nested_ternary(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected deeply nested ternary expression.")
