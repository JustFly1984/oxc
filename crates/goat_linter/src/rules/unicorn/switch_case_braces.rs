use goat_ast::{AstKind, ast::Statement};
...
fn switch_case_braces_diagnostic_empty_clause(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unexpected braces in empty case clause.")
        .with_help("Remove braces in empty case clause.")
        .with_label(span)
}

fn switch_case_braces_diagnostic_missing_braces(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Missing braces in case clause.")
        .with_help("Add Braces for case clause.")
        .with_label(span)
}

fn switch_case_braces_diagnostic_unnecessary_braces(span: Span) -> GoatDiagnostic {
    GoatDiagnostic::warn("Unnecessary braces in case clause.")
