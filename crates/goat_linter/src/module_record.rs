...
use goat_semantic::Semantic;
use goat_span::{CompactStr, Span};
pub use goat_syntax::module_record::RequestedModule;
...
impl<'a> From<&goat_syntax::module_record::NameSpan<'a>> for NameSpan {
    fn from(other: &goat_syntax::module_record::NameSpan<'a>) -> Self {
...
impl<'a> From<&goat_syntax::module_record::ImportEntry<'a>> for ImportEntry {
    fn from(other: &goat_syntax::module_record::ImportEntry<'a>) -> Self {
        Self {
...
impl<'a> From<&goat_syntax::module_record::ImportImportName<'a>> for ImportImportName {
    fn from(other: &goat_syntax::module_record::ImportImportName<'a>) -> Self {
        match other {
            goat_syntax::module_record::ImportImportName::Name(name_span) => {
                Self::Name(NameSpan::from(name_span))
            }
            goat_syntax::module_record::ImportImportName::NamespaceObject => Self::NamespaceObject,
            goat_syntax::module_record::ImportImportName::Default(span) => Self::Default(*span),
        }
    }
}
...
impl<'a> From<&goat_syntax::module_record::ExportEntry<'a>> for ExportEntry {
    fn from(other: &goat_syntax::module_record::ExportEntry<'a>) -> Self {
        Self {
            statement_span: other.statement_span,
            span: other.span,
...
impl<'a> From<&goat_syntax::module_record::ExportImportName<'a>> for ExportImportName {
    fn from(other: &goat_syntax::module_record::ExportImportName<'a>) -> Self {
        match other {
            goat_syntax::module_record::ExportImportName::Name(name_span) => {
                Self::Name(NameSpan::from(name_span))
            }
            goat_syntax::module_record::ExportImportName::All => Self::All,
            goat_syntax::module_record::ExportImportName::AllButDefault => Self::AllButDefault,
            goat_syntax::module_record::ExportImportName::Null => Self::Null,
        }
    }
}
...
impl<'a> From<&goat_syntax::module_record::ExportExportName<'a>> for ExportExportName {
    fn from(other: &goat_syntax::module_record::ExportExportName<'a>) -> Self {
        match other {
            goat_syntax::module_record::ExportExportName::Name(name_span) => {
                Self::Name(NameSpan::from(name_span))
            }
            goat_syntax::module_record::ExportExportName::Default(span) => Self::Default(*span),
            goat_syntax::module_record::ExportExportName::Null => Self::Null,
        }
    }
}
...
impl<'a> From<&goat_syntax::module_record::ExportLocalName<'a>> for ExportLocalName {
    fn from(other: &goat_syntax::module_record::ExportLocalName<'a>) -> Self {
        match other {
            goat_syntax::module_record::ExportLocalName::Name(name_span) => {
                Self::Name(NameSpan::from(name_span))
            }
            goat_syntax::module_record::ExportLocalName::Default(name_span) => {
                Self::Default(NameSpan::from(name_span))
            }
            goat_syntax::module_record::ExportLocalName::Null => Self::Null,
        }
    }
}
...
impl ModuleRecord {
    pub fn new(
        path: &Path,
        other: &goat_syntax::module_record::ModuleRecord,
        _semantic: &Semantic,
    ) -> Self {
        Self {
