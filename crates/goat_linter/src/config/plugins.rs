...
///
/// This logic is replicated on JS side in `normalizePluginName` in `apps/goatlint/src-js/plugins/load.ts`.
/// The 2 implementations must be kept in sync.
///
/// # Examples
///
/// ```
/// use goat_linter::normalize_plugin_name;
///
...
impl Default for LintPlugins {
    #[inline]
    fn default() -> Self {
        // update `goat_linter::table::RuleTable` when changing the defaults
...
impl TryFrom<&str> for LintPlugins {
    ...
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        ...
        match value {
            ...
            "goat" | "deepscan" => Ok(LintPlugins::OXC),
