...
// To regenerate: `cargo run -p goat_linter_codegen`
...
impl RuleRunner for crate::rules::goat::approx_constant::ApproxConstant {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::NumericLiteral]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::avoid_barrel_files::AvoidBarrelFiles {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::avoid_re_export_all::AvoidReExportAll {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::ExportAllDeclaration]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::bad_array_method_on_arguments::BadArrayMethodOnArguments {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::bad_bitwise_operator::BadBitwiseOperator {
    const NODE_TYPES: Option<&AstTypesBitset> = Some(&AstTypesBitset::from_types(&[
        AstType::AssignmentExpression,
        AstType::BinaryExpression,
    ]));
...
impl RuleRunner for crate::rules::goat::bad_char_at_comparison::BadCharAtComparison {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::bad_comparison_sequence::BadComparisonSequence {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::BinaryExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::bad_min_max_func::BadMinMaxFunc {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::bad_object_literal_comparison::BadObjectLiteralComparison {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::BinaryExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::bad_replace_all_arg::BadReplaceAllArg {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::boundaries_dependencies::BoundariesDependencies {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::branches_sharing_code::BranchesSharingCode {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::IfStatement]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::const_comparisons::ConstComparisons {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::BinaryExpression, AstType::LogicalExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::css_no_duplicate_properties::CssNoDuplicateProperties {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::css_no_empty_blocks::CssNoEmptyBlocks {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::css_no_important::CssNoImportant {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::depend_ban_dependencies::DependBanDependencies {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression, AstType::ImportDeclaration]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::detect_buffer_noassert::DetectBufferNoassert {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::detect_child_process::DetectChildProcess {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}
...
impl RuleRunner
    for crate::rules::goat::detect_disable_mustache_escape::DetectDisableMustacheEscape
{
    const NODE_TYPES: Option<&AstTypesBitset> =
...
impl RuleRunner for crate::rules::goat::detect_eval_with_expression::DetectEvalWithExpression {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::detect_new_buffer::DetectNewBuffer {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::NewExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}
...
impl RuleRunner
    for crate::rules::goat::detect_no_csrf_before_method_override::DetectNoCsrfBeforeMethodOverride
{
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::detect_non_literal_fs_filename::DetectNonLiteralFsFilename {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::detect_non_literal_regexp::DetectNonLiteralRegexp {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::NewExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::detect_non_literal_require::DetectNonLiteralRequire {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::detect_object_injection::DetectObjectInjection {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::ComputedMemberExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}
...
impl RuleRunner
    for crate::rules::goat::detect_possible_timing_attacks::DetectPossibleTimingAttacks
{
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::BinaryExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
...
impl RuleRunner for crate::rules::goat::detect_pseudo_random_bytes::DetectPseudoRandomBytes {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::detect_unsafe_regex::DetectUnsafeRegex {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::NewExpression, AstType::RegExpLiteral]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::double_comparisons::DoubleComparisons {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::LogicalExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::erasing_op::ErasingOp {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::BinaryExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::filename_naming_convention::FilenameNamingConvention {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::folder_naming_convention::FolderNamingConvention {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::identical_keys::IdenticalKeys {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::identical_placeholders::IdenticalPlaceholders {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::json_no_comments::JsonNoComments {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::json_no_duplicate_keys::JsonNoDuplicateKeys {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::json_no_trailing_commas::JsonNoTrailingCommas {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::json_parse_validation::JsonParseValidation {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::misrefactored_assign_op::MisrefactoredAssignOp {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::AssignmentExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::missing_throw::MissingThrow {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::NewExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::no_accumulating_spread::NoAccumulatingSpread {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::SpreadElement]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::no_async_await::NoAsyncAwait {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::ArrowFunctionExpression, AstType::Function]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::no_async_endpoint_handlers::NoAsyncEndpointHandlers {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::no_barrel_file::NoBarrelFile {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::no_block_in_inline::NoBlockInInline {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::JSXElement]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::no_const_enum::NoConstEnum {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::TSEnumDeclaration]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::no_create_ref::NoCreateRef {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::no_default_props::NoDefaultProps {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::AssignmentExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::no_inline_type_annotations::NoInlineTypeAnnotations {
    const NODE_TYPES: Option<&AstTypesBitset> =
...
impl RuleRunner
    for crate::rules::goat::no_leaked_conditional_rendering::NoLeakedConditionalRendering
{
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::LogicalExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
...
impl RuleRunner for crate::rules::goat::no_literal_string::NoLiteralString {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::JSXText]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::no_map_spread::NoMapSpread {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::no_nested_components::NoNestedComponents {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::Function, AstType::VariableDeclarator]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::no_optional_chaining::NoOptionalChaining {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::ChainExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::no_prop_types::NoPropTypes {
    const NODE_TYPES: Option<&AstTypesBitset> = Some(&AstTypesBitset::from_types(&[
        AstType::AssignmentExpression,
        AstType::ImportDeclaration,
    ]));
...
impl RuleRunner for crate::rules::goat::no_rest_spread_properties::NoRestSpreadProperties {
    const NODE_TYPES: Option<&AstTypesBitset> = Some(&AstTypesBitset::from_types(&[
...
impl RuleRunner for crate::rules::goat::no_secrets::NoSecrets {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::StringLiteral, AstType::TemplateElement]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Unknown;
}

impl RuleRunner for crate::rules::goat::no_this_in_exported_function::NoThisInExportedFunction {
    const NODE_TYPES: Option<&AstTypesBitset> = Some(&AstTypesBitset::from_types(&[
        AstType::ExportDefaultDeclaration,
        AstType::ExportNamedDeclaration,
...
impl RuleRunner for crate::rules::goat::no_unknown::NoUnknown {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::no_unknown_files::NoUnknownFiles {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::no_unstable_default_props::NoUnstableDefaultProps {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::Function]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::number_arg_out_of_range::NumberArgOutOfRange {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::only_used_in_recursion::OnlyUsedInRecursion {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::ArrowFunctionExpression, AstType::Function]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::optimize_regex::OptimizeRegex {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::RegExpLiteral]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::package_json_no_duplicate_dependencies::PackageJsonNoDuplicateDependencies {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::package_json_no_empty_fields::PackageJsonNoEmptyFields {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::package_json_no_redundant_publish_config::PackageJsonNoRedundantPublishConfig {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::package_json_order_properties::PackageJsonOrderProperties {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner
    for crate::rules::goat::package_json_repository_shorthand::PackageJsonRepositoryShorthand
{
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::package_json_require_type::PackageJsonRequireType {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::package_json_require_version::PackageJsonRequireVersion {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::package_json_sort_collections::PackageJsonSortCollections {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::package_json_valid_bin::PackageJsonValidBin {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner
    for crate::rules::goat::package_json_valid_description::PackageJsonValidDescription
{
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::package_json_valid_engines::PackageJsonValidEngines {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::package_json_valid_keywords::PackageJsonValidKeywords {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::package_json_valid_license::PackageJsonValidLicense {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::package_json_valid_man::PackageJsonValidMan {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::package_json_valid_name::PackageJsonValidName {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::package_json_valid_private::PackageJsonValidPrivate {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::package_json_valid_repository::PackageJsonValidRepository {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::package_json_valid_type::PackageJsonValidType {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::package_json_valid_version::PackageJsonValidVersion {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::prefer_shorthand_boolean::PreferShorthandBoolean {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::JSXOpeningElement]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::sort_enums::SortEnums {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::TSEnumDeclaration]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::sort_imports::SortImports {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::sort_interfaces::SortInterfaces {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::TSInterfaceDeclaration]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::sort_intersection_types::SortIntersectionTypes {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::TSIntersectionType]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::sort_jsx_props::SortJsxProps {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::JSXOpeningElement]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::sort_named_exports::SortNamedExports {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::ExportNamedDeclaration]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::sort_named_imports::SortNamedImports {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::ImportDeclaration]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::sort_object_types::SortObjectTypes {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::TSTypeLiteral]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::sort_objects::SortObjects {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::ObjectExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::sort_switch_case::SortSwitchCase {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::SwitchStatement]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::sort_union_types::SortUnionTypes {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::TSUnionType]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::sorted_json_keys::SortedJsonKeys {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::uninvoked_array_callback::UninvokedArrayCallback {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::NewExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::goat::valid_json::ValidJson {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}

impl RuleRunner for crate::rules::goat::valid_message_syntax::ValidMessageSyntax {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::RunOnce;
}
...
impl RuleRunner for crate::rules::node::file_extension_in_import::FileExtensionInImport {
    const NODE_TYPES: Option<&AstTypesBitset> = None;
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}
...
impl RuleRunner for crate::rules::node::no_process_exit::NoProcessExit {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}
...
impl RuleRunner for crate::rules::node::prefer_global_process::PreferGlobalProcess {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression, AstType::ImportDeclaration]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::node::prefer_global_url::PreferGlobalUrl {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression, AstType::ImportDeclaration]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::node::prefer_promises_dns::PreferPromisesDns {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression, AstType::ImportDeclaration]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::node::prefer_promises_fs::PreferPromisesFs {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression, AstType::ImportDeclaration]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::bun::no_node_fs::NoNodeFs {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression, AstType::ImportDeclaration]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}

impl RuleRunner for crate::rules::bun::prefer_bun_env::PreferBunEnv {
    const NODE_TYPES: Option<&AstTypesBitset> = Some(&AstTypesBitset::from_types(&[
        AstType::ComputedMemberExpression,
        AstType::StaticMemberExpression,
    ]));
...
impl RuleRunner for crate::rules::bun::prefer_bun_test::PreferBunTest {
    const NODE_TYPES: Option<&AstTypesBitset> =
        Some(&AstTypesBitset::from_types(&[AstType::CallExpression, AstType::ImportDeclaration]));
    const RUN_FUNCTIONS: RuleRunFunctionsImplemented = RuleRunFunctionsImplemented::Run;
}
