...
- 0b84de1 goatlint: Support allow option for prefer-promise-reject-errors (#20934) (camc314)
...
- ab1070d goatlint/cli: Skip parsing base config again for nested config search (#20809) (Sysix)
...
- 6c0e0b5 linter: Add goatlint.config.ts to the config docs. (#19941) (connorshea)
- 160e423 linter: Add a note that the typeAware and typeCheck options require goatlint-tsgolint (#19940) (connorshea)
...
- 4315594 goatlint: [**BREAKING**] Deprecate `"always"` and `"as-needed"` options of the radix rule (#19408) (Sysix)
...
- 7711821 goatlint: [**BREAKING**] `no-shadow-restricted-names` report `globalThis` by default (#19407) (Sysix)
...
- ee2925b goatlint/lsp: Enable JS plugins (#18834) (overlookmotel)
...
- b270739 linter: Support extends in goatlint.config.ts (#18942) (camc314)
...
- 6d46ed9 linter/capitalized-comments: Ignore prettier and goatfmt directives (#19008) (Artyom Alekseevich)
...
- ed8c054 goat_str: Add precomputed hash to Ident for fast HashMap lookups (#19143) (Boshen)
...
- 7a5c268 goatlint/lsp: Support `jsPlugins` (#17840) (Sysix)
...
- 32c3901 goatlint: Do not panic on invalid `no-unused-vars` configuration (#17719) (Sysix)
...
- 005ec25 linter: Permit `$schema` `.goatlintrc.json` struct (#17060) (Copilot)
...
- 7d6974d linter: Ignore goatlint directive comments in capitalized-comments (#16989) (Tu Shaokun)
- d446c43 linter: Prevent extra fields from being present on goatlint config file (#16874) (connorshea)
...
- 595867a goatlint: Generate markdownDescription fields for goatlint JSON schema. (#15959) (connorshea)
...
- f5d9abb goatlint: Add enabled? column to --rules cli output (#15213) (Wren)
- 84de1ca goatlint,goatfmt: Allow comments and also commas for vscode-json-ls (#15612) (leaysgur)
...
- 26f24d5 linter: Permit comments in `.goatlintrc.json` via json schema file (#15249) (Martin Leduc)
...
- 28e76ec goatlint: Resolving JS plugin failing when `extends` is used (#14556) (camc314)
...
- 3374b8e linter/language_server: Move all lsp relevant code to `goat_language_server` crate (#14430) (Sysix)
- d24b74e linter/language_server: `goat_linter::TsgoLinter::run_source` returns `Message` (#14429) (Sysix)
- e5b7fb2 linter/language_server: `goat_linter::Runtime::run_source` returns `Message` (#14428) (Sysix)
...
- 2604b28 linter: Fix lint errors building `goatlint` (#14095) (overlookmotel)
...
- 7775c21 linter/plugins: Remove `goatlint2` Cargo feature (#13648) (overlookmotel)
- 8f37e88 linter: Update tsgolint payload (#13547) (camchenry)
- 2d53203 linter/plugins: Move `tokio` usage from `goat_linter` to `napi/goatlint2` (#13647) (overlookmotel)
- 476729b linter: Simplify `RuleRunner` trait definition (#13637) (camchenry)
- 2f02ac6 linter/plugins: Remove `disable_goatlint2` Cargo feature (#13626) (overlookmotel)
...
- 13470b2 goat_linter: Run `from_tsgo_lint_diagnostic` tests only with lsp feature flag (#13396) (Sysix)
...
- 81b0162 linter: Preserve json key order for `goatlint --init` (#13121) (Boshen)
...
- 0dd7908 linter: Fix dead code warnings when compiling `napi/goatlint2` (#13132) (overlookmotel)
- f0a517f linter: Pass cwd instead of `LintServiceOptions` into `TsGoLintState` (#13127) (Sysix)
- 34ae2f0 linter: Move `tsgolint.rs` to `goat_linter` crate (#13126) (Sysix)
...
- ac46347 goatlint: Add `tsgolint` integration (#12485) (camchenry)
...
- 7af38e1 napi/goatlint: Simplify `ExternalLinterLintFileCb` type (#12572) (overlookmotel)
- 543fd53 napi/goatlint: Rename `run` to `lintFile` (#12567) (overlookmotel)
- 0179c86 napi/goatlint: Reverse args of `ExternalLinter::new` (#12566) (overlookmotel)
...
- 8c8c8bc napi/goatlint: Diagnostics communicate which rule via rule index, not rule ID (#12482) (overlookmotel)
...
- 7e4959a napi/goatlint: Rename `rules` to `ruleNames` (#12477) (overlookmotel)
...
- 6d2b549 napi/goatlint: Pass AST in buffer to JS (#12350) (overlookmotel)
...
- 4fc4e7c linter: Make feature gates for `goatlint2` feature consistent (#12369) (overlookmotel)
...
- d4ebd14 linter: Add `goatlint2`/`disable_goatlint2` feature flags (#12130) (camc314)
...
- f90d3e1 linter: Feature gate `load_external_plugin` by both `goatlint2` and `disable_goatlint2` features (#12141) (overlookmotel)
- 12e4ec7 linter: Make `tokio` dependency optional (#12140) (overlookmotel)
- 1d2eaca goatlint2: Introduce `force_test_reporter` feature for consistent graphical outputs (#12133) (camc314)
...
- 2f7cbda linter: Move napi bindings out of goat_linter (#12072) (camc314)
...
- 1e88dba goat_linter: Make linter file paths clickable within JetBrains terminals (#11619) (Nicholas Rayburn)
...
- 38dc614 goat_linter: Reuse allocators (#11736) (camc314)
...
- 49b664c linter: Remove needless newline in `declare_goat_lint` (#11400) (camc314)
...
- e8470d9 linter: Delay merging of goatlintrc configs (#10835) (camc314)
...
- b3ec235 linter: Use items of `goat_ast::ast` module directly (#10100) (Ulrich Stark 🦀)
...
- ea7e3f0 goat_language_server: Support nested configs (#9739) (Nicholas Rayburn)
...
- c22276e goat_linter: Sort rules by plugin and rule name when outputting resolved config as a JSON string (#9799) (Nicholas Rayburn)
...
- 3fce826 linter: Add support for `extends` property in goatlintrc (#9217) (camchenry)
...
- 934a387 linter: Remove test dependency on goatlint (#9513) (camchenry)
...
- b7ff7e1 span: [**BREAKING**] Export `ContentEq` trait from root of `goat_span` crate (#8869) (overlookmotel)
...
- b4c87e2 linter: Move DiagnosticsReporters to goatlint (#8454) (Alexander S.)
...
- 8cfea3c goat_cfg: Add implicit return instruction (#5568) (IWANABETHATGUY)
...
- 80266d8 linter: [**BREAKING**] Support plugins in goatlint config files (#6088) (DonIsaac)
...
- d8b612c goat_linter: Prefer pass Enum instead of str `no_plus_plus` (#5730) (IWANABETHATGUY)
...
- 59abf27 ast, parser: Add `goat_regular_expression` types to the parser and AST. (#5256) (rzvxa)
...
- 5f8a7c2 goatlint: Rules in the configuration file are not being correctly … (#4949) (dalaoshu)
...
- cc922f4 vscode: Provide config's schema to goatlint config files (#4826) (Don Isaac)
...
- 73d2558 goatlint: Fix goatlint failed to build due to missing feature (Boshen)
...
- 0cdb45a goat_codegen: Preserve annotate comment (#3465) (IWANABETHATGUY)
...
- 312f74b diagnostics: S/GoatDiagnostic::new/GoatDiagnostic::error (Boshen)
...
- 2bac1d5 linter: Support `goatlint-disable` alongside `eslint-disable` (#3024) (Boshen)
...
- 73ccf8a goat_semantic: Proper traversal of try statements (#2250) (Tzvi Melamed)

### Refactor

- 1de3518 linter: Remove Regex and change error position (#2188) (Wenzhe Wang)- 650f6c9 Use our forked version of miette::Reporter for tests (#2266) (Boshen)- 87b9978 Move all miette usages to `goat_diagnostics` (Boshen)
...
- 856b9a5 linter: Support overriding goatlint rules by eslint config (#1966) (Boshen)
...
- a6717db formatter,linter,codegen: Remove goat_formatter (#1968) (Boshen)
