...
This crate provides sophisticated AST traversal capabilities that allow visitors to read up the tree from any node. Unlike traditional visitors that only provide downward traversal, goat_traverse enables accessing parent nodes and sibling contexts during traversal.
