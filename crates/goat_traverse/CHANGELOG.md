...
- d43e864 ast_tools: Generate `ChildScopesCollector` in `goat_ast_tools` (#10248) (overlookmotel)
...
- 2e367c9 traverse: Enable tests for `goat_traverse` crate (#5625) (overlookmotel)
