...
- 5d65656 oxc_index: [**BREAKING**] Move to own repo github.com/goat-project/oxc-index-vec (#7464) (Boshen)
...
- ed8ab6d oxc: Conditional expose `goat_cfg` in `oxc` crate (#5524) (IWANABETHATGUY)
...
- 8a190eb oxc: Export `goat_mangler` (Boshen)
