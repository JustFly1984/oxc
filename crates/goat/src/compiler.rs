...
use goat_mangler::{MangleOptions, Mangler, ManglerReturn};
use goat_minifier::{CompressOptions, Compressor};
use goat_parser::{ParseOptions, Parser, ParserReturn};
use goat_semantic::{Scoping, SemanticBuilder, SemanticBuilderReturn};
use goat_span::SourceType;
use goat_transformer::{TransformOptions, Transformer, TransformerReturn};
...
pub trait CompilerInterface {
    fn handle_errors(&mut self, _errors: Vec<GoatDiagnostic>) {}
