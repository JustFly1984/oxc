...
//! ```bash
//! cargo run -p goat_minifier --example minifier [filename] [options]
//! ```
//!
//! ## Options
//!
...
use goat_codegen::{Codegen, CodegenOptions, CodegenReturn, CommentOptions};
...
// Instruction:
// create a `test.js`,
// run `cargo run -p goat_minifier --example minifier` or `just example minifier`
