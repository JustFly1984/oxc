...
- `cargo run -p goat_minifier --example minifier` - Try the minifier

## Key Dependencies

- [`goat_ecmascript`](../goat_ecmascript) - ECMAScript operations and constant evaluation
- [`goat_semantic`](../goat_semantic) - Scope and symbol analysis
- [`goat_mangler`](../goat_mangler) - Variable renaming
