...
use goat_allocator::{CloneIn, TakeIn, Vec};
use goat_ast::{NONE, ast::*};
use goat_compat::ESFeature;
use goat_ecmascript::BoundNames;
use goat_ecmascript::constant_evaluation::{ConstantEvaluation, ConstantValue, DetermineValueType};
use goat_ecmascript::side_effects::MayHaveSideEffectsContext;
use goat_ecmascript::{ToJsString, ToNumber, side_effects::MayHaveSideEffects};
use goat_semantic::ReferenceFlags;
use goat_span::GetSpan;
use goat_span::SPAN;
use goat_syntax::precedence::GetPrecedence;
use goat_syntax::{
