...
- 110c300 goat_ecmascript: `+[false]` and `+[true]` should evaluate to `NaN` (#19174) (copilot-swe-agent)
...
- 01d7b13 goat_minifier: Enable sourcemap feature in dev mode (#18131) (Armano)
...
- 11dd63b minifier: Use `goat_ast::NONE` (#14322) (sapphi-red)
...
- c0ef5f3 minifier: Use goat_data_structures::stack::Stack for ClassSymbolsStack (#14029) (sapphi-red)
...
- f1862c4 minifier: Add comprehensive documentation for goat_minifier (#13938) (Boshen)
...
- 53c51f9 minifier: Remove clippy allow directives and fix needless_pass_by_ref_mut warnings in goat_minifier (#13030) (Copilot)
...
- 9d6e14b ecmascript: Move tests to `goat_minifier` due to cyclic dependency with `goat_parser` (#7542) (Boshen)
...
- f4cdc56 minifier: Use constant folding unary expression from `goat_ecmascript` (#6647) (Boshen)
- 67ad08a minifier: Unify `ValueType` (#6545) (Boshen)
- bbca743 minifier: Move string methods to `goat_ecmascript` (#6472) (Boshen)
...
- 2b21be3 goat_minifier: Define plugin with postfix wildcard (#4979) (IWANABETHATGUY)
...
- e0832f8 minifier: Use `goat_traverse` for AST passes (#4725) (Boshen)
