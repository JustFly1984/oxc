...
Many optimizations rely on [`goat_ecmascript`](../../goat_ecmascript) for ECMAScript operations like constant evaluation, type conversion, and side effect analysis.
...
**Size Impact**: High
**Description**: Evaluates expressions at compile time using `goat_ecmascript::constant_evaluation`
...
**Size Impact**: High
**Description**: Uses shorter equivalent syntax leveraging `goat_ecmascript` type conversions
