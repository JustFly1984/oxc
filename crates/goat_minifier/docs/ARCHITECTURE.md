...
- `goat_ast`: AST node definitions
- `goat_semantic`: Scope and symbol analysis
- `goat_ecmascript`: ECMAScript operations
- `goat_mangler`: Variable renaming
- `goat_codegen`: Output generation
