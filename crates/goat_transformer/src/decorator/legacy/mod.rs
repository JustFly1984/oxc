...
use goat_allocator::{Address, CloneIn, GetAddress, TakeIn, UnstableAddress, Vec as ArenaVec};
use goat_ast::{NONE, ast::*};
use goat_ast_visit::{Visit, VisitMut};
use goat_data_structures::stack::NonEmptyStack;
use goat_semantic::{ScopeFlags, ScopeId, SymbolFlags};
use goat_span::SPAN;
use goat_syntax::operator::AssignmentOperator;
use goat_traverse::{Ancestor, BoundIdentifier, Traverse, ast_operations::get_var_name_from_node};
