...
use goat_allocator::{Box as ArenaBox, TakeIn};
use goat_ast::ast::*;
use goat_data_structures::stack::SparseStack;
use goat_semantic::{Reference, ReferenceFlags, SymbolId};
use goat_span::{ContentEq, SPAN};
use goat_traverse::{MaybeBoundIdentifier, Traverse};
...
impl<'a> LegacyDecoratorMetadata<'a> {
    ...
    #[inline]
    fn is_type_symbol(symbol_id: Option<goat_semantic::SymbolId>, ctx: &TraverseCtx<'a>) -> bool {
