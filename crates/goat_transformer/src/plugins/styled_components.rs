...
use goat_ast::{AstBuilder, NONE, ast::*};
use goat_data_structures::{inline_string::InlineString, slice_iter::SliceIter};
use goat_semantic::SymbolId;
use goat_span::SPAN;
use goat_traverse::{Ancestor, Traverse};
...
mod tests {
    ...
    use goat_ast::{AstBuilder, ast::TemplateElementValue};
    use goat_span::SPAN;
