...
use goat_allocator::{StringBuilder, TakeIn, Vec as ArenaVec};
use goat_ast::{NONE, ast::*};
use goat_ast_visit::{VisitMut, walk_mut};
use goat_data_structures::stack::NonEmptyStack;
use goat_ecmascript::{ToInt32, ToUint32};
use goat_semantic::{ScopeFlags, ScopeId};
use goat_span::{Ident, IdentHashMap, SPAN, Span, Str};
use goat_syntax::{
...
use goat_traverse::{BoundIdentifier, Traverse};
