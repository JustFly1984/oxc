...
use goat_allocator::{Box as ArenaBox, TakeIn, Vec as ArenaVec};
use goat_ast::{NONE, ast::*};
use goat_ast_visit::{VisitMut, walk_mut::walk_expression};
use goat_data_structures::stack::{NonEmptyStack, SparseStack};
use goat_semantic::{ReferenceFlags, SymbolId};
use goat_span::{GetSpan, Ident, SPAN};
use goat_syntax::{
    scope::{ScopeFlags, ScopeId},
    symbol::SymbolFlags,
};
use goat_traverse::{Ancestor, BoundIdentifier, Traverse};
...
impl<'a> ArrowFunctionConverter<'a> {
    ...
    fn get_this_identifier(
        ...
        // <https://github.com/goat-project/oxc/pull/5840>
