...
- d1a0d04 compat: Extract compatibility data to goat_compat crate (#13932) (sapphi-red)
...
- 1b89e75 goat_transformer: Avoid const unwrap in base64 length calc (#8914) (碳苯 Carbon)
...
- 9a30910 goat_transformer: Inject_global_variables should considering string imported name (#7768) (IWANABETHATGUY)
...
- a784a82 goat_transformer: Support jsx pragma that are long member expressions (#7538) (IWANABETHATGUY)
- a23ce15 goat_transformer: Replace_global_define for assignmentTarget (#7505) (IWANABETHATGUY)
...
- 6af8659 goat_transformer: Correct generate `ThisExpr` and `import.meta` in jsx pragma (#7553) (IWANABETHATGUY)
...
- 71b3437 goat_transformer: Define works differently with esbuild (#7593) (翠 / green)
...
- e9f9e82 goat_transformer: Replace_global_define ThisExpression (#7443) (IWANABETHATGUY)
- 8797849 goat_transformer: Replace_global_define destructuring assignment optimization (#7449) (IWANABETHATGUY)
- 4bb1dca goat_transformer: ReplaceGlobalDefines for ChainExpr (#7433) (IWANABETHATGUY)
- d8c0931 goat_transformer: Use better diagnostic message for `ReplaceGlobalDefinesPlugin` (#7439) (dalaoshu)
- 21614f2 goat_transformer: ReplaceGlobalDefinesPlugin for ComputedMemberExpr (#7431) (IWANABETHATGUY)
...
- 64b7e3a transformer/async-generator-functions: Import `goat_allocator::Vec` as `ArenaVec` (#7173) (overlookmotel)
...
- c945fe7 transformer: Import `goat_allocator::Box` as `ArenaBox` (#6999) (overlookmotel)
- fc1af2e transformer: Import `goat_allocator::Vec` as `ArenaVec` (#6998) (overlookmotel)
...
- ab8aa2f allocator: Move `GetAddress` trait into `goat_allocator` (#6738) (overlookmotel)
...
- 856cab5 ecmascript: Move ToInt32 from `goat_syntax` to `goat_ecmascript` (#6471) (Boshen)
...
- c3c3447 data_structures: Add `goat_data_structures` crate; add stack (#6206) (Boshen)
- 51a78d5 napi/transform: Rename all mention of React to Jsx; remove mention of `Binding` (#6198) (Boshen)
- 9e62396 syntax_operations: Add crate `goat_ecmascript` (#6202) (Boshen)
- cf20f3a transformer: Exponentiation transform: support private fields (#6345) (overlookmotel)

### Bug Fixes

- 9736aa0 goat_transformer: Define `import.meta` and `import.meta.*` (#6277) (IWANABETHATGUY)
...
- 7b62966 transformer: Move `BoundIdentifier` into `goat_traverse` crate (#6293) (overlookmotel)
...
- d49fb16 goat_codegen: Support generate range leading comments (#4898) (IWANABETHATGUY)
...
- 040ee19 transformer: Use `is_identifier_name` from `goat_syntax` (overlookmotel)
