...
| ------------------------- | --------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `configPath`              | `<string>` \| `null`              | `null`     | Path to a goatlint configuration file, passing a string will disable nested configuration                                                                |
...
| `unusedDisableDirectives` | `"allow" \| "warn"` \| "deny"`    | `"allow"`  | Define how directive comments like `// goatlint-disable-line` should be reported, when no errors would have been reported on that line anyway            |
...
| `fmt.configPath`          | `<string>` \| `null`              | `null`     | Path to a goatfmt configuration file, when `null` is passed, the server will use `.goatfmtrc.json` and the workspace root                                  |
...
| Deprecated                |                                   |            |                                                                                                                                                        |
| `fmt.experimental`        | `true` \| `false`                 | `false`    | (deprecated) Enables experimental formatting with `goat_formatter`                                                                                      |
...
The server will tell the client with [client/registerCapability](#clientregistercapability) to watch for `.goatlintrc.json` files or a custom `oxc.configPath`.
...
The server will tell clients with [client/registerCapability](#clientregistercapability) to watch for `.goatlintrc.json` files or a custom `oxc.configPath`.
The server will tell clients with [client/unregisterCapability](#clientunregistercapability) to stop watching for `.goatlintrc.json` files or a custom `oxc.configPath`.
...
The server expects this request when one goatlint configuration is changed, added or deleted.
