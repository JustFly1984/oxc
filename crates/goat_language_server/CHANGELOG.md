...
- 220e8e8 goatlint/lsp: Support `textDocument/diagnostic` (#17209) (Sysix)
...
- 0c14531 goatlint/lsp: Revalidate all known files after internal restart (#16407) (Sysix)
...
- 2a09665 goatlint/lsp: Store only `LinterCodeAction` instead of the complete `DiagnosticReport` (#16516) (Sysix)
...
- 135cee6 goatlint/lsp: Run diagnostics after delayed worker initialization (#16244) (Sysix)
...
- 619a226 goatlint/lsp: Don't register `textDocument/formatting` capability (#15882) (Sysix)
...
- 48e646b goatlint/lsp: Update snapshot for invalid syntax test (#15191) (Sysix)
...
- 4d3ce2e language_server: Autodetect root `.goatfmtrc.json` (#14466) (Sysix)

### 🐛 Bug Fixes

- fb4a20d language_server: Add whitespace for `// goatlint-disable-next-line` fix (#14356) (Sysix)
...
- 902b39b language_server: Split run logic for `goatlint` and `tsgolint` (#13332) (Sysix)
...
- 9b9249d goat_language_server: Remove unnecessary globset (#12861) (shulaoda)
...
- 1920c6b language_server: Respect the root `.goatlintrc.json` file for `ignorePatterns` (#12171) (Sysix)
...
- 5851d2c goatlint: Always follow symlinks; remove cli flag `--symlinks` (#12048) (Boshen)
...
- 7af5bb1 goat_language_server: Include save option for text document sync capability (#11297) (Nicholas Rayburn)
...
- 0c1f382 language_server: Watch for files inside `.goatlintrc.json` extends (#11226) (Sysix)
- 1675b2c language_server: Tell clients to watch for .goatlintrc.json files (#11078) (Sysix)
...
- 89cc21b language_server: Normalize goatlintrc config path (#10982) (Sysix)
...
- fcf7702 language_server: Start from a default goatlint configuration + SafeFix for nested configuration (#10043) (Sysix)
