...
- 8f0b865 ast_tools: Generate mapping of trait name to crate in `goat_ast_macros` (#8870) (overlookmotel)
- e693ff3 ast_tools: Generate list of helper attributes in `goat_ast_macros` crate (#8852) (overlookmotel)
...
- f290191 goat_ast_macros: Fix `syn` lacking features to build (Boshen)
