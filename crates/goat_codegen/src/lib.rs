...
// Re-export `IndentChar` from `goat_data_structures`
pub use goat_data_structures::code_buffer::IndentChar;
...
pub struct Codegen<'a> {
    ...
    /// is obtained by [`goat_span::SourceType::is_jsx`]
    is_jsx: bool,
...
impl<'a> Codegen<'a> {
    ...
    fn add_source_mapping_end(&mut self, span: Span) {
            ...
            && !span.is_empty()
        {
            ...
            // When goat_codegen adds punctuation (semicolons, newlines) that don't exist in the
