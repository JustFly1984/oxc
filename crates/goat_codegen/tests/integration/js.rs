...
use goat_ast::AstBuilder;
use goat_codegen::{Codegen, CodegenOptions, IndentChar};
use goat_span::SPAN;
...
#[test]
fn v8_intrinsics() {
    let parse_opts = goat_parser::ParseOptions {
        allow_v8_intrinsics: true,
        ..goat_parser::ParseOptions::default()
    };
...
fn template_literal_escape_when_building_ast() {
    use goat_ast::ast::TemplateElementValue;
