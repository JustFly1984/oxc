...
//! ```bash
//! cargo run -p goat_codegen --example codegen [filename] [--minify] [--twice]
//! ```
//!
//! ## Options
//!
...
// Instruction:
// create a `test.js`,
// run `cargo run -p goat_codegen --example codegen`
// or `cargo watch -x "run -p goat_codegen --example codegen"`
