...
//! ```bash
//! cargo run -p goat_formatter --example formatter [filename]
//! cargo run -p goat_formatter --example formatter -- --no-semi [filename]
//! cargo run -p goat_formatter --example formatter -- --jsdoc [filename]
//! cargo run -p goat_formatter --example formatter -- --diff [filename]
//! ```
