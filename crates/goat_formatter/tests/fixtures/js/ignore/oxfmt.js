...
// and replace all `goatfmt-ignore` to `goatfmt-ignore` to verify that goatfmt correctly ignores those comments.
function a() {
  // goatfmt-ignore
  var fnString =
...
function f() {
  return   {a:1}; // goatfmt-ignore
}

function g() {
  throw   new Error(  "boom"  ); // goatfmt-ignore
}
