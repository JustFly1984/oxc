...
This directory contains snapshot-based tests for the goat_formatter crate.
...
cargo test -p goat_formatter --test mod
```
...
cargo test -p goat_formatter fixtures::js::comments

# Run all tests in the js directory (including subdirectories)
cargo test -p goat_formatter fixtures::js

# Run a specific test file
cargo test -p goat_formatter fixtures::js::comments::test
```

### Accept new/changed snapshots

```bash
cargo insta test --accept -p goat_formatter --test mod
```

### Accept snapshots for specific tests

```bash
FILTER="arrow" cargo insta test --accept -p goat_formatter --test mod
```

### Review snapshots interactively

```bash
cargo insta review -p goat_formatter
```
