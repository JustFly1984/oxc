...
- c4c55cc formatter: Add `goatfmt-ignore` ignore comment support (#17916) (Dunqing)
...
- bbadb8e goatfmt/sort-imports: Hard line inside multiline import leads to i… (#17880) (nilptr)
...
- 0a39cba goatfmt: Update wrong doc comment (#17288) (leaysgur)
...
- afd6c44 goatfmt: Support `quoteProps: consistent` in `Oxfmtrc` (#16721) (leaysgur)
...
- 8babdf9 goatfmt: Improve docs for `.goatfmtrc.jsonc` config fields and add markdownDescription fields to JSON Schema (#16587) (connorshea)
...
- 862bdf7 goatfmt: Detect unsupported experimental options (take2) (#16088) (leaysgur)
...
- 9706a1a goatfmt: Ignore unsupported options (#16085) (leaysgur)
...
- 381e08c goatfmt: More friendly JSON schema (#14879) (leaysgur)
...
- 8077f9b goatfmt: Provide JSON schema for `.goatfmtrc.json` (#14399) (leaysgur)
...
- 5856bc9 goat_formatter: Fix arrow_parentheses: 'avoid' > 'as-needed' (#14462) (leaysgur)
