...
impl From<&GoatDiagnostic> for OxcError {
...
impl From<goat_diagnostics::Severity> for Severity {
    fn from(value: goat_diagnostics::Severity) -> Self {
        match value {
            goat_diagnostics::Severity::Error => Self::Error,
            goat_diagnostics::Severity::Warning => Self::Warning,
            goat_diagnostics::Severity::Advice => Self::Advice,
        }
    }
}
