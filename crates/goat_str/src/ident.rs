...
use goat_estree::{ESTree, JsonSafeString, Serializer as ESTreeSerializer};
#[cfg(feature = "serialize")]
use serde::{Serialize, Serializer as SerdeSerializer};

use crate::{CompactStr, Str};

/// An identifier string for goat_allocator with a precomputed hash.
///
...
impl goat_allocator::hash_map::Equivalent<Ident<'_>> for str {
    #[inline]
...
pub type ArenaIdentHashMap<'alloc, V> =
    goat_allocator::HashMap<'alloc, Ident<'alloc>, V, IdentBuildHasher>;
