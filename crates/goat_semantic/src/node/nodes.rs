...
impl<'a> AstNodes<'a> {
    ...
    /// Access the underlying struct from [`goat_ast`].
    #[inline]
    ...
    ///
    /// See [goat_cfg::ControlFlowGraph] for more information.
    #[inline]
    #[cfg(feature = "cfg")]
    ...
    ///
    /// use goat_ast::AstType;
    /// use goat_semantic::{AstNodes, AstTypesBitset};
    ///
