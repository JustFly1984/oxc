...
/// and `goat_allocator::Vec` is not `Send`.
///
/// ### `Sync`
///
...
/// ### `Send`
///
/// `Allocator` is `Send`. `goat_allocator::Vec` is not, but that restriction is purely to prevent a `Vec`
...
impl Scoping {
    ...
    ///
    /// [`VariableDeclaration`]: goat_ast::ast::VariableDeclaration
    /// [`Function`]: goat_ast::ast::Function
    /// [`BindingIdentifier`]: goat_ast::ast::BindingIdentifier
    /// [`BindingPattern`]: goat_ast::ast::BindingPattern
    #[inline]
    ...
    ///
    /// [`ReferenceId`]s can be found in [goat_ast::ast::IdentifierReference] and similar nodes.
    #[inline]
