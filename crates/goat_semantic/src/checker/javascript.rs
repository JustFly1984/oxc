...
use goat_ast::{AstKind, ModuleDeclarationKind, ast::*};
use goat_ecmascript::{BoundNames, IsSimpleParameterList, PropName};
use goat_span::{GetSpan, ModuleKind, Span, best_match};
use goat_syntax::{
    class::ClassId,
    number::NumberBase,
