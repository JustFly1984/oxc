...
use goat_span::{Ident, IdentHashMap, SourceType, Span};
use goat_syntax::{
...
pub struct SemanticBuilder<'a> {
    ...
    pub(crate) errors: RefCell<Vec<GoatDiagnostic>>,
...
impl<'a> SemanticBuilder<'a> {
    ...
    ///
    /// [`ControlFlowGraph`]: goat_cfg::ControlFlowGraph
    #[must_use]
    #[cfg(feature = "cfg")]
    ...
    /// Push a Syntax Error
    pub(crate) fn error(&self, error: GoatDiagnostic) {
    ...
    fn record_ast_node(&mut self) {
        ...
        // <https://github.com/goat-project/oxc/pull/4273>
        if self.cfg.is_some()
