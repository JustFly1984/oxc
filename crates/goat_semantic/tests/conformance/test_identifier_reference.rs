use goat_ast::{AstKind, ast::IdentifierReference};
use goat_diagnostics::GoatDiagnostic;
use goat_semantic::{NodeId, Reference};
use goat_span::GetSpan;
use goat_syntax::reference::ReferenceId;
...
fn missing_reference_id(reference: &IdentifierReference) -> TestResult {
    GoatDiagnostic::error("After semantic analysis, all IdentifierReferences should have a reference_id, even if a symbol could not be resolved.")
