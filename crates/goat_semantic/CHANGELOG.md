...
- b4f3d00 goat_semantic: Make `Scoping` cloneable (#9953) (IWANABETHATGUY)
...
- 30a869e semantic: Use `goat_allocator::HashMap` in `ScopeTree` (#8554) (overlookmotel)
...
- 98d7946 semantic: Import flags and ID types from `goat_syntax` (#7887) (overlookmotel)
...
- 805fbac goat_cfg: Better control flow graph dot dot repr (#5731) (IWANABETHATGUY)
...
- 6002560 span: Fix memory leak by implementing inlineable string for goat_allocator (#2294) (Boshen)
...
- 2768195 goat_semantic: Improve sample visualization (#2251) (Tzvi Melamed)
...
- f4674f3 goat_semantic: Handle short-circuiting operators in CFG (#2252) (Tzvi Melamed)
...
- 8e43eef semantic: Improve declare symbol logic in FormalParameters (#2088) (Dunqing)- 87b9978 Move all miette usages to `goat_diagnostics` (Boshen)
