...
- 83ca7f5 diagnostics: Fully document `goat_diagnostics` (#5865) (DonIsaac)
...
- 91b39c4 oxc_diagnostic: Impl DerefMut for GoatDiagnostic (#5474) (IWANABETHATGUY)
...
### Features
- 6068e6b Add error codes to GoatDiagnostic (#4334) (DonIsaac)
...
### Refactor
- 87b9978 Move all miette usages to `goat_diagnostics` (Boshen)
