...
//! ```bash
//! cargo run -p goat_parser --example parser [filename] [--ast] [--estree] [--comments]
//! ```
//!
//! ## Options
//!
...
// Instruction:
// create a `test.js`,
// run `cargo run -p goat_parser --example parser`
// or `just watch "cargo run -p goat_parser --example parser"`
